...
class ExplanWordAttr:
    ...
    def is_verb_noun(self) -> bool:
        """ Существительное входит в базовую часть модели управления, в него преобразуется глагол """
    ...
    def __and__(self : 'ExplanWordAttr', arg2 : 'ExplanWordAttr') -> 'ExplanWordAttr':
        ...
        if (arg2 is not None): 
            val2 = arg2.value
        return ExplanWordAttr._new3609(((val1) & (val2)))
    ...
    @staticmethod
    def _new3609(_arg1 : int) -> 'ExplanWordAttr':
        res = ExplanWordAttr()
        res.value = _arg1
        return res
