...
class OptimizerHelper:
    ...
    def __process_participles(gr : 'SemGraph') -> bool:
        ...
        first_pass4159 = True
        while True:
            if first_pass4159: first_pass4159 = False
            else: i += 1
            ...
            if (not has): 
                continue
            if (own is None): 
                dum = SemObject._new3572(gr, SemObjectType.NOUN)
                if (obj.morph is not None): 
                    dum.morph = MorphWordForm._new3573(MorphClass.NOUN, obj.morph.number, obj.morph.gender, obj.morph.case_)
    ...
    def __collapse_anafors(gr : 'SemGraph') -> bool:
        ...
        first_pass4160 = True
        while True:
            if first_pass4160: first_pass4160 = False
            else: i += 1
            if (not (i < len(gr.objects))): break
            obj = gr.objects[i]
    ...
    def __process_formulas(objs : typing.List['SemObject']) -> bool:
        ...
        first_pass4161 = True
        while True:
            if first_pass4161: first_pass4161 = False
            else: i += 1
    ...
    def __process_pointers(objs : typing.List['SemObject']) -> bool:
        ...
        first_pass4162 = True
        while True:
            if first_pass4162: first_pass4162 = False
            else: i += 1
            if (not (i < len(objs))): break
            o = objs[i]
            ...
            if (not ok): 
                ...
                first_pass4163 = True
                while True:
                    if first_pass4163: first_pass4163 = False
                    else: j += 1
            ...
            if (not ok): 
                continue
            first = SemObject._new3572(o.graph, SemObjectType.ADJECTIVE)
        ...
        first_pass4164 = True
        while True:
            if first_pass4164: first_pass4164 = False
            else: i += 1
            if (not (i < len(objs))): break
            o = objs[i]
            if (o.typ != SemObjectType.NOUN): 
