...
class NGLink(object):
    ...
    def __calc_genetive(self) -> None:
        ...
        if (isinstance(self.from0_.source.source, NumbersWithUnitToken)): 
            ...
            if (isinstance(self.to.source.source, NumbersWithUnitToken)): 
                return
        links = SemanticHelper.try_create_links(self.to.source.source, self.from0_.source.source, None)
        if (links is not None): 
            for li in links: 
                if (li.role != SemanticRole.AGENT): 
                    self.coef = li.rank
                    if (self.coef < 0.5): 
                        self.coef = 0.5
                    if (li.role == SemanticRole.STRONG or li.idiom): 
                        self.coef *= (2)
                    return
        non_gen_text = False
    ...
    def __calc_agent(self, noplural : bool) -> float:
        ...
        if (vf.misc.mood == MorphMood.IMPERATIVE): 
            self.coef = -1
            return self.coef
        links = SemanticHelper.try_create_links(self.to_verb, self.from0_.source.source, None)
        if (links is not None): 
            for li in links: 
                if (li.role == SemanticRole.AGENT): 
                    self.coef = li.rank
    ...
    def __calc_pacient(self, noplural : bool) -> float:
        ...
        if (links is not None): 
            for li in links: 
                if (li.role == SemanticRole.PACIENT): 
                    self.coef = li.rank
                    if (self.coef < 0.5): 
                        self.coef = 0.5
                    return self.coef
    ...
    def __calc_actant(self) -> float:
        ...
        if (links is not None): 
            for li in links: 
                if (li.role != SemanticRole.AGENT and li.role != SemanticRole.PACIENT): 
                    self.coef = li.rank
                    if (self.coef < 0.5): 
                        self.coef = 0.5
                    return self.coef
    ...
    @staticmethod
    def _new3567(_arg1 : 'NGLinkType', _arg2 : 'NGItem', _arg3 : 'NGItem', _arg4 : bool) -> 'NGLink':
        res = NGLink()
        res.typ = _arg1
        res.from0_ = _arg2
        res.to = _arg3
    ...
    @staticmethod
    def _new3569(_arg1 : 'NGLinkType') -> 'NGLink':
        res = NGLink()
        res.typ = _arg1
        return res
    
    @staticmethod
    def _new3570(_arg1 : 'NGItem', _arg2 : 'NGLinkType') -> 'NGLink':
        res = NGLink()
        res.from0_ = _arg1
        res.typ = _arg2
        return res
    ...
    @staticmethod
    def _new3578(_arg1 : 'NGItem', _arg2 : 'VerbPhraseToken', _arg3 : 'NGLinkType') -> 'NGLink':
        res = NGLink()
        res.from0_ = _arg1
        res.to_verb = _arg2
        res.typ = _arg3
    ...
    @staticmethod
    def _new3594(_arg1 : 'NGLinkType', _arg2 : 'NGItem', _arg3 : 'VerbPhraseToken') -> 'NGLink':
        res = NGLink()
        res.typ = _arg1
        res.from0_ = _arg2
        res.to_verb = _arg3
