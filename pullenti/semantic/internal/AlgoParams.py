...
class AlgoParams:
    ...
    def _static_ctor():
        ...
        AlgoParams.PARAMS.append(AlgoParam._new3540("TransitiveCoef", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3540("NextModel", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3540("NgLink", 1, 3, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3540("List", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3540("VerbPlural", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3540("CaseAccord", 1, 3, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3540("MorphAccord", 1, 3, 1))
