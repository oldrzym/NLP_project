...
class NGSegmentVariant(object):
    ...
    def calc_coef(self) -> float:
        ...
        first_pass4151 = True
        while True:
            if first_pass4151: first_pass4151 = False
            else: i += 1
            ...
            first_pass4152 = True
            while True:
                if first_pass4152: first_pass4152 = False
                else: k += 1
                if (not (k < i)): break
                li = self.links[k]
                if (li is None): 
        ...
        first_pass4153 = True
        while True:
            if first_pass4153: first_pass4153 = False
            else: i += 1
            if (not (i < len(self.links))): break
            ...
            if (k >= (len(list0_) - 1) and list0_[k].and_before): 
                ...
                if (k >= len(list0_)): 
                    ...
                    self.coef = -1
                    return self.coef
            ngli = NGLink._new3569(NGLinkType.LIST)
            k = 0
            ...
            if (not ok or lalink is None): 
                continue
            test = NGLink._new3570(lalink.from0_, lalink.typ)
            j = 0
            j = 0
        ...
        first_pass4154 = True
        while True:
            if first_pass4154: first_pass4154 = False
            else: i += 1
            if (not (i < len(self.links))): break
            li = self.links[i]
            if (li is None): 
        ...
        first_pass4155 = True
        while True:
            if first_pass4155: first_pass4155 = False
            else: i += 1
            if (not (i < len(self.links))): break
            li = self.links[i]
            if (li is None): 
        ...
        first_pass4156 = True
        while True:
            if first_pass4156: first_pass4156 = False
            else: i += 1
            if (not (i < len(self.links))): break
            li = self.links[i]
            if (li is None): 
    ...
    def get_list(self, ord0_ : int) -> typing.List['NGItem']:
        ...
        if (li.typ == NGLinkType.LIST): 
            if (li.to_verb is None): 
                return None
            res = list()
            res.append(NGItem._new3571(SentItem(li.to_verb), ord0_ - 1))
            res.append(ngit)
        i = ord0_ + 1
        first_pass4157 = True
        while True:
            if first_pass4157: first_pass4157 = False
            else: i += 1
            if (not (i < len(self.links))): break
            li = self.links[i]
    ...
    def correct_morph(self) -> None:
        ...
        first_pass4158 = True
        while True:
            if first_pass4158: first_pass4158 = False
            else: i += 1
            if (not (i < len(self.links))): break
            li = self.links[i]
            if (li is None): 
    ...
    @staticmethod
    def _new3568(_arg1 : 'NGSegment') -> 'NGSegmentVariant':
