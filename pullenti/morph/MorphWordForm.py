...
class MorphWordForm(MorphBaseInfo):
    ...
    def _has_morph_equals(self, list0_ : typing.List['MorphWordForm']) -> bool:
        for mr in list0_: 
            if ((self.class0_.equals(mr.class0_) and self.number == mr.number and self.gender == mr.gender) and self.normal_case == mr.normal_case and self.normal_full == mr.normal_full): 
                ...
                return True
        for mr in list0_: 
            if ((self.class0_.equals(mr.class0_) and self.number == mr.number and self.case_.equals(mr.case_)) and self.normal_case == mr.normal_case and self.normal_full == mr.normal_full): 
                mr.gender = Utils.valToEnum((mr.gender) | (self.gender), MorphGender)
                return True
        for mr in list0_: 
            if ((self.class0_.equals(mr.class0_) and self.gender == mr.gender and self.case_.equals(mr.case_)) and self.normal_case == mr.normal_case and self.normal_full == mr.normal_full): 
    ...
    @staticmethod
    def _new752(_arg1 : 'MorphCase', _arg2 : 'MorphNumber', _arg3 : 'MorphGender') -> 'MorphWordForm':
        res = MorphWordForm()
        res.case_ = _arg1
        res.number = _arg2
        res.gender = _arg3
    ...
    @staticmethod
    def _new755(_arg1 : 'MorphClass', _arg2 : 'MorphMiscInfo') -> 'MorphWordForm':
        res = MorphWordForm()
        res.class0_ = _arg1
        res.misc = _arg2
        return res
    ...
    @staticmethod
    def _new3573(_arg1 : 'MorphClass', _arg2 : 'MorphNumber', _arg3 : 'MorphGender', _arg4 : 'MorphCase') -> 'MorphWordForm':
        res = MorphWordForm()
        res.class0_ = _arg1
        res.number = _arg2
        res.gender = _arg3
