...
class ParenthesisToken(MetaToken):
    ...
    def try_attach(t : 'Token') -> 'ParenthesisToken':
        ...
        if (ok and t.next0_ is not None): 
            ...
            t1 = t.next0_
            if (t1.get_morph_class_in_dictionary().equals(MorphClass.VERB)): 
        ...
        if (t1 is not None): 
            ...
            r = t1.get_referent()
            if (r is not None): 
                res = ParenthesisToken._new1347(t, t1, r)
    ...
    @staticmethod
    def _new1347(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'Referent') -> 'ParenthesisToken':
