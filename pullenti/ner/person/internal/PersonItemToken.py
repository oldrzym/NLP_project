...
class PersonItemToken(MetaToken):
    ...
    class MorphPersonItemVariant(MorphBaseInfo):
        ...
        @staticmethod
        def _new3199(_arg1 : str, _arg2 : 'MorphBaseInfo', _arg3 : bool, _arg4 : str) -> 'MorphPersonItemVariant':
    ...
    class MorphPersonItem:
        ...
        def correct_lastname_variants(self) -> None:
            ...
            for v in self.vars0_: 
                if (v.value is not None): 
                    if (PersonItemToken.MorphPersonItem.ends_with_std_surname(v.value) or LanguageHelper.ends_with(v.value, "АЯ") or LanguageHelper.ends_with(v.value, "ОЙ")): 
                        self.is_lastname_has_std_tail = True
                        strong_std = True
                        break
                    elif (LanguageHelper.ends_with(v.value, "КИЙ") or LanguageHelper.ends_with(v.value, "ЫЙ")): 
                        self.is_lastname_has_std_tail = True
            if (self.is_lastname_has_std_tail): 
                for i in range(len(self.vars0_) - 1, -1, -1):
                    if ((((self.vars0_[i].value is not None and not PersonItemToken.MorphPersonItem.ends_with_std_surname(self.vars0_[i].value) and not LanguageHelper.ends_with(self.vars0_[i].value, "АЯ")) and not LanguageHelper.ends_with(self.vars0_[i].value, "ОЙ") and not LanguageHelper.ends_with(self.vars0_[i].value, "КИЙ")) and not LanguageHelper.ends_with(self.vars0_[i].value, "ЫЙ") and not LanguageHelper.ends_with(self.vars0_[i].value, "ИХ")) and not LanguageHelper.ends_with(self.vars0_[i].value, "ЫХ")): 
                        if (not self.vars0_[i].class0_.is_proper_surname or strong_std): 
                            del self.vars0_[i]
                            continue
        ...
        @staticmethod
        def _new3144(_arg1 : bool) -> 'MorphPersonItem':
            res = PersonItemToken.MorphPersonItem()
            res.is_has_std_postfix = _arg1
            return res
        
        @staticmethod
        def _new3152(_arg1 : str) -> 'MorphPersonItem':
            res = PersonItemToken.MorphPersonItem()
            res.term = _arg1
            return res
        
        @staticmethod
        def _new3155(_arg1 : str, _arg2 : bool) -> 'MorphPersonItem':
            res = PersonItemToken.MorphPersonItem()
            res.term = _arg1
        ...
        @staticmethod
        def _new3187(_arg1 : bool) -> 'MorphPersonItem':
            res = PersonItemToken.MorphPersonItem()
    ...
    def is_asian_item(self, last : bool) -> bool:
        ...
        if (len(self.value) == 1): 
            ...
            return False
        if (len(self.value) > 5 and self.begin_token == self.end_token and not last): 
            mc = self.begin_token.get_morph_class_in_dictionary()
    ...
    def __add_postfix_info(self, postfix : str, gen : 'MorphGender') -> None:
        ...
        if (self.firstname is not None): 
            ...
            self.firstname = PersonItemToken.MorphPersonItem._new3144(True)
            self.firstname.vars0_.append(PersonItemToken.MorphPersonItemVariant(self.value, MorphBaseInfo._new3145(gen), False))
    ...
    def try_attach_latin(t : 'Token') -> 'PersonItemToken':
        ...
        if (tt.term == "JR" or tt.term == "JNR" or tt.term == "JUNIOR"): 
            ...
            if (tt.next0_ is not None and tt.next0_.is_char('.')): 
                t1 = tt.next0_
            return PersonItemToken._new3146(tt, t1, PersonItemToken.ItemType.SUFFIX, "JUNIOR")
        if ((tt.term == "SR" or tt.term == "SNR" or tt.term == "SENIOR") or tt.term == "FITZ" or tt.term == "FILS"): 
            t1 = tt
            if (tt.next0_ is not None and tt.next0_.is_char('.')): 
                t1 = tt.next0_
            return PersonItemToken._new3146(tt, t1, PersonItemToken.ItemType.SUFFIX, "SENIOR")
        ...
        if (not initials and len(tt.term) == 2 and tt.chars.is_capital_upper): 
            if (not LanguageHelper.is_latin_vowel(tt.term[0]) and not LanguageHelper.is_latin_vowel(tt.term[1])): 
                initials = True
        if (initials): 
            rii = PersonItemToken._new3148(tt, tt, PersonItemToken.ItemType.INITIAL, tt.term, tt.chars)
            if (tt.next0_ is not None and tt.next0_.is_char('.')): 
        ...
        if (tt.length_char == 1): 
            ...
            if (tt.next0_.is_char('.')): 
                return PersonItemToken._new3148(tt, tt.next0_, PersonItemToken.ItemType.INITIAL, tt.term, tt.chars)
            ...
            if (not LanguageHelper.is_latin_vowel(tt.term[0]) or tt.whitespaces_after_count != 1): 
                ...
                if (nex is not None and nex.typ == PersonItemToken.ItemType.VALUE): 
                    return PersonItemToken._new3148(tt, tt, PersonItemToken.ItemType.INITIAL, tt.term, tt.chars)
                return None
            if (tt.term == "I"): 
                return None
            return PersonItemToken._new3148(tt, tt, PersonItemToken.ItemType.VALUE, tt.term, tt.chars)
        ...
        if (cla.is_proper_name or ((cla.is_proper and ((tt.morph.gender == MorphGender.MASCULINE or tt.morph.gender == MorphGender.FEMINIE))))): 
            res.firstname = PersonItemToken.MorphPersonItem._new3152(res.value)
        ...
        if (cla.is_proper_surname): 
            res.lastname = PersonItemToken.MorphPersonItem._new3152(res.value)
            for wf in tt.morph.items: 
                if (wf.is_in_dictionary): 
        ...
        if (ots is not None): 
            if (ots[0].termin.ignore_terms_order): 
                return PersonItemToken._new3154(ots[0].begin_token, ots[0].end_token, PersonItemToken.ItemType.REFERENT, Utils.asObjectOrNull(ots[0].item.tag, PersonReferent), ots[0].morph)
            res.lastname = PersonItemToken.MorphPersonItem._new3155(ots[0].termin.canonic_text, True)
            for ot in ots: 
                if (ot.termin is not None): 
                    mi = ot.morph
                    if (ot.termin.gender == MorphGender.MASCULINE or ot.termin.gender == MorphGender.FEMINIE): 
                        mi = MorphBaseInfo._new3145(ot.termin.gender)
        ...
        if (res.value.startswith("MAC")): 
            ...
            res.lastname = PersonItemToken.MorphPersonItem._new3144(True)
            res.lastname.vars0_.append(PersonItemToken.MorphPersonItemVariant(res.value, MorphBaseInfo(), True))
        return res
    ...
    def try_attach(t : 'Token', attrs : 'ParseAttr'=ParseAttr.NO, prev_list : typing.List['PersonItemToken']=None) -> 'PersonItemToken':
        ...
        if (isinstance(t, NumberToken)): 
            ...
            if (nt.begin_token == nt.end_token and nt.typ == NumberSpellingType.WORDS and ((not nt.begin_token.chars.is_all_lower or (((attrs) & (PersonItemToken.ParseAttr.MUSTBEITEMALWAYS))) != (PersonItemToken.ParseAttr.NO)))): 
                res00 = PersonItemToken.try_attach(nt.begin_token, attrs, prev_list)
                if (res00 is not None): 
                    res00.begin_token = res00.end_token = t
                    return res00
        if (isinstance(t, ReferentToken)): 
            ...
            if (rt.begin_token == rt.end_token and rt.begin_token.chars.is_capital_upper): 
                res00 = PersonItemToken.try_attach(rt.begin_token, attrs, prev_list)
                if (res00 is not None): 
                    res01 = PersonItemToken.try_attach(t.next0_, attrs, prev_list)
                    if ((res01 is not None and res01.lastname is not None and res01.firstname is None) and res01.middlename is None): 
                        return None
                    res00.begin_token = res00.end_token = t
                    res00.is_in_dictionary = True
                    return res00
        if (((((isinstance(t, TextToken)) and t.length_char == 2 and ((t.term == "JI" or t.term == "IO"))) and t.chars.is_all_upper and not t.is_whitespace_after) and t.next0_ is not None and t.next0_.is_char('.')) and t.kit.base_language.is_ru): 
            re1 = PersonItemToken._new3146(t, t.next0_, PersonItemToken.ItemType.INITIAL, ("Л" if t.term == "JI" else "Ю"))
        ...
        if ((((((isinstance(t, TextToken)) and t.length_char == 1 and t.term == "J") and t.chars.is_all_upper and not t.is_whitespace_after) and (isinstance(t.next0_, NumberToken)) and t.next0_.value == "1") and t.next0_.typ == NumberSpellingType.DIGIT and t.next0_.next0_ is not None) and t.next0_.next0_.is_char('.')): 
            re1 = PersonItemToken._new3146(t, t.next0_.next0_, PersonItemToken.ItemType.INITIAL, "Л")
            re1.chars.is_cyrillic_letter = True
            re1.chars.is_all_upper = True
            return re1
        if ((((((isinstance(t, TextToken)) and t.length_char == 1 and t.term == "I") and t.chars.is_all_upper and not t.is_whitespace_after) and (isinstance(t.next0_, NumberToken)) and t.next0_.value == "1") and t.next0_.typ == NumberSpellingType.DIGIT and t.next0_.next0_ is not None) and t.next0_.next0_.is_char('.')): 
            if (prev_list is not None and prev_list[0].chars.is_cyrillic_letter): 
                re1 = PersonItemToken._new3146(t, t.next0_.next0_, PersonItemToken.ItemType.INITIAL, "П")
                re1.chars.is_cyrillic_letter = True
                re1.chars.is_all_upper = True
                return re1
        res = PersonItemToken.__try_attach(t, attrs, prev_list)
        if (res is not None): 
            return res
        if (t.chars.is_latin_letter and (((attrs) & (PersonItemToken.ParseAttr.CANBELATIN))) != (PersonItemToken.ParseAttr.NO)): 
            ...
            if (ad is not None): 
                ots = ad.local_ontology.try_attach(t, PersonReferent.OBJ_TYPENAME, False)
            if (t is not None and t.kit.ontology is not None and ots is None): 
                ots = t.kit.ontology.attach_token(PersonReferent.OBJ_TYPENAME, t)
            if (ots is not None and (isinstance(t, TextToken))): 
                if (ots[0].termin.ignore_terms_order): 
                    return PersonItemToken._new3154(ots[0].begin_token, ots[0].end_token, PersonItemToken.ItemType.REFERENT, Utils.asObjectOrNull(ots[0].item.tag, PersonReferent), ots[0].morph)
                res = PersonItemToken._new3162(ots[0].begin_token, ots[0].end_token, t.term, ots[0].chars)
                res.lastname = PersonItemToken.MorphPersonItem._new3155(ots[0].termin.canonic_text, True)
                for ot in ots: 
                    if (ot.termin is not None): 
                        mi = ot.morph
        ...
        if (((isinstance(t, NumberToken)) and t.length_char == 1 and (((attrs) & (PersonItemToken.ParseAttr.CANINITIALBEDIGIT))) != (PersonItemToken.ParseAttr.NO)) and t.next0_ is not None and t.next0_.is_char_of(".„")): 
            if (t.value == "1"): 
                return PersonItemToken._new3148(t, t.next0_, PersonItemToken.ItemType.INITIAL, "І", CharsInfo._new3165(True))
            if (t.value == "0"): 
                return PersonItemToken._new3148(t, t.next0_, PersonItemToken.ItemType.INITIAL, "О", CharsInfo._new3165(True))
            if (t.value == "3"): 
                return PersonItemToken._new3148(t, t.next0_, PersonItemToken.ItemType.INITIAL, "З", CharsInfo._new3165(True))
        if ((((isinstance(t, NumberToken)) and t.length_char == 1 and (((attrs) & (PersonItemToken.ParseAttr.CANINITIALBEDIGIT))) != (PersonItemToken.ParseAttr.NO)) and t.next0_ is not None and t.next0_.chars.is_all_lower) and not t.is_whitespace_after and t.next0_.length_char > 2): 
            ...
            if (num == "3" and t.next0_.chars.is_cyrillic_letter): 
                return PersonItemToken._new3148(t, t.next0_, PersonItemToken.ItemType.VALUE, "З" + t.next0_.term, CharsInfo._new3171(True, True))
            if (num == "0" and t.next0_.chars.is_cyrillic_letter): 
                return PersonItemToken._new3148(t, t.next0_, PersonItemToken.ItemType.VALUE, "О" + t.next0_.term, CharsInfo._new3171(True, True))
        if (((((isinstance(t, TextToken)) and t.length_char == 1 and t.chars.is_letter) and t.chars.is_all_upper and (t.whitespaces_after_count < 2)) and (isinstance(t.next0_, TextToken)) and t.next0_.length_char == 1) and t.next0_.chars.is_all_lower): 
            ...
            if (cou < 5): 
                if (prev_list is not None and len(prev_list) > 0 and prev_list[len(prev_list) - 1].typ == PersonItemToken.ItemType.INITIAL): 
                    ...
                    ne = PersonItemToken.try_attach(t1.next0_, attrs, None)
            ...
            while tt is not None and tt.end_char <= t1.end_char: 
                ...
                tt = tt.next0_
            res = PersonItemToken._new3146(t, t1, PersonItemToken.ItemType.VALUE, Utils.toStringStringIO(val))
            res.chars = CharsInfo._new3176(True, is_cyr, not is_cyr, True)
            return res
        if ((((attrs) & (PersonItemToken.ParseAttr.MUSTBEITEMALWAYS))) != (PersonItemToken.ParseAttr.NO) and (isinstance(t, TextToken)) and not t.chars.is_all_lower): 
            res = PersonItemToken._new3177(t, t, t.term)
            return res
        if (((t.chars.is_all_upper and (isinstance(t, TextToken)) and t.length_char == 1) and prev_list is not None and len(prev_list) > 0) and (t.whitespaces_before_count < 2) and prev_list[0].chars.is_capital_upper): 
            ...
            if ((last.typ == PersonItemToken.ItemType.VALUE and last.lastname is not None and last.lastname.is_in_dictionary) and len(prev_list) == 1): 
                ...
                ok = True
            if (ok): 
                return PersonItemToken._new3178(t, t, t.term, PersonItemToken.ItemType.INITIAL)
        return None
    ...
    def __try_attach(t : 'Token', attrs : 'ParseAttr', prev_list : typing.List['PersonItemToken']=None) -> 'PersonItemToken':
        ...
        if (tt is None): 
            if (t.chars.is_letter and t.chars.is_capital_upper and (isinstance(t, ReferentToken))): 
                ...
                if (rt.begin_token == rt.end_token and not (isinstance(rt.referent, PersonReferent))): 
                    res0 = PersonItemToken.__try_attach(rt.begin_token, attrs, None)
                    if (res0 is None): 
                        res0 = PersonItemToken._new3179(rt, rt, rt.referent.to_string_ex(True, t.kit.base_language, 0).upper(), rt.chars, rt.morph)
                        res0.lastname = PersonItemToken.MorphPersonItem._new3152(res0.value)
                    else: 
                    ...
                    if ((t.next0_ is not None and t.next0_.is_hiphen and (isinstance(t.next0_.next0_, TextToken))) and t.next0_.next0_.get_morph_class_in_dictionary().is_proper_secname): 
                        res1 = PersonItemToken.try_attach(t.next0_.next0_, PersonItemToken.ParseAttr.NO, None)
        ...
        if (tt.length_char == 1 or tt.term == "ДЖ"): 
            if (tt.next0_ is None): 
                return None
            ini = tt.term
            ci = CharsInfo._new3181(tt.chars.value)
            ...
            if (tt.next0_.is_char('.')): 
                return PersonItemToken._new3148(tt, tt.next0_, PersonItemToken.ItemType.INITIAL, ini, ci)
            if ((tt.next0_.is_char_of(",;„") and prev_list is not None and len(prev_list) > 0) and prev_list[len(prev_list) - 1].typ == PersonItemToken.ItemType.INITIAL): 
                return PersonItemToken._new3148(tt, tt, PersonItemToken.ItemType.INITIAL, ini, ci)
            if ((tt.next0_.whitespaces_after_count < 2) and (tt.whitespaces_after_count < 2) and ((tt.term == "Д" or tt.term == "О" or tt.term == "Н"))): 
                if (BracketHelper.is_bracket(tt.next0_, False) and (isinstance(tt.next0_.next0_, TextToken))): 
                    if (tt.next0_.next0_.chars.is_cyrillic_letter): 
                        pit0 = PersonItemToken.try_attach(tt.next0_.next0_, Utils.valToEnum((attrs) | (PersonItemToken.ParseAttr.CANBELOWER), PersonItemToken.ParseAttr), prev_list)
                        if (pit0 is not None): 
                            pit0.begin_token = tt
                            if (pit0.value is not None): 
        ...
        if (len(ad.local_ontology.items) < 1000): 
            ots = ad.local_ontology.try_attach(t, PersonReferent.OBJ_TYPENAME, False)
            if (ots is not None and ots[0].begin_token != ots[0].end_token and not ots[0].begin_token.next0_.is_hiphen): 
                if (PersonAttrToken.try_attach_word(ots[0].begin_token, False) is not None): 
                    ots = (None)
        if (t is not None and t.kit.ontology is not None and ots is None): 
            ots = t.kit.ontology.attach_token(PersonReferent.OBJ_TYPENAME, t)
        sur_prefix = None
        ...
        if (ots is not None): 
            ...
            if (ots[0].begin_token == ots[0].end_token and mc.is_proper_name and not mc.is_proper_surname): 
                ots = (None)
        if (ots is not None): 
            res = PersonItemToken._new3162(ots[0].begin_token, ots[0].end_token, tt.term, ots[0].chars)
            res.lastname = PersonItemToken.MorphPersonItem._new3187(True)
            res.lastname.term = ots[0].termin.canonic_text.replace(" - ", "-")
            res.value = MiscHelper.get_text_value_of_meta_token(ots[0], GetTextAttr.NO)
            for ot in ots: 
                if (ot.termin is not None): 
                    mi = ot.morph
            ...
            res = PersonItemToken._new3179(t, t, tt.term, tt.chars, tt.morph)
            if (tt.term in PersonItemToken.M_SUR_PREFIXES): 
                if (((tt.is_value("БЕН", None) or tt.is_value("ВАН", None))) and (((attrs) & (PersonItemToken.ParseAttr.ALTVAR))) != (PersonItemToken.ParseAttr.NO) and ((tt.next0_ is None or not tt.next0_.is_hiphen))): 
                    ...
                    if (tt.next0_ is not None): 
                        t1 = tt.next0_
                        if ((isinstance(t1, TextToken)) and ((t1.term == "Л" or t1.term == "ЛЬ" or t1.term in PersonItemToken.M_SUR_PREFIXES))): 
                            res.end_token = t1
                            res.value += t1.term
                            t1 = t1.next0_
                        elif ((t1.is_hiphen and (isinstance(t1.next0_, TextToken)) and t1.next0_.next0_ is not None) and ((t1.next0_.term == "Л" or t1.next0_.term == "ЛЬ" or t1.next0_.term in PersonItemToken.M_SUR_PREFIXES))): 
                            res.end_token = t1.next0_
                            res.value += t1.next0_.term
                            t1 = t1.next0_.next0_
                        if (t1 is not None and t1.is_hiphen): 
                            tt = (Utils.asObjectOrNull(t1.next0_, TextToken))
                        elif ((((attrs) & (PersonItemToken.ParseAttr.SURNAMEPREFIXNOTMERGE))) != (PersonItemToken.ParseAttr.NO) and t1 is not None and t1.chars.is_all_lower): 
                            tt = (None)
                        else: 
        ...
        for wff in tt.morph.items: 
            ...
            if (wf.class0_.is_proper_surname or sur_prefix is not None): 
                if (res.lastname is None): 
                    res.lastname = PersonItemToken.MorphPersonItem._new3152(tt.term)
                if (adj is not None): 
                    if (not wf.is_in_dictionary and adj.number == MorphNumber.SINGULAR): 
                        ...
                        if (val == tt.term): 
                            if (not PersonItemToken.MorphPersonItem.ends_with_std_surname(wf.normal_case)): 
                                break
                    adj = (None)
                ...
                elif ((v.gender == MorphGender.MASCULINE and not wf.is_in_dictionary and ((v.value.endswith("ИН") or v.value.endswith("ІН")))) and (isinstance(t, TextToken)) and ((t.term.endswith("ИНА") or t.term.endswith("ІНА")))): 
                    vv = PersonItemToken.MorphPersonItemVariant(t.term, MorphBaseInfo._new3100(MorphCase.NOMINATIVE, MorphGender.MASCULINE), True)
                    vv.value = t.term
                ...
                if (tt.term.endswith("ИХ") or tt.term.endswith("ЫХ")): 
                    if (res.lastname.vars0_[0].value != tt.term): 
                        res.lastname.vars0_.insert(0, PersonItemToken.MorphPersonItemVariant(tt.term, MorphBaseInfo._new3194(MorphCase.ALL_CASES, Utils.valToEnum((MorphGender.MASCULINE) | (MorphGender.FEMINIE), MorphGender), MorphClass._new3193(True)), True))
            ...
            if (wf.class0_.is_proper_name and wf.number != MorphNumber.PLURAL): 
                ...
                if (ok): 
                    if (res.firstname is None): 
                        res.firstname = PersonItemToken.MorphPersonItem._new3152(tt.term)
            ...
            if (not PersonItemToken.MorphPersonItem.ends_with_std_surname(tt.term)): 
                if (wf.class0_.is_proper_secname): 
                    if (res.middlename is None): 
                        res.middlename = PersonItemToken.MorphPersonItem._new3152(tt.term)
                    elif (wf.misc is not None and wf.misc.form == MorphForm.SYNONYM): 
                        continue
                ...
                if (not std_end and (tt.whitespaces_after_count < 2)): 
                    ...
                    if (npt is not None and npt.end_token != npt.begin_token): 
                        if ((prev_list is not None and len(prev_list) == 1 and prev_list[0].firstname is not None) and prev_list[0].firstname.is_in_dictionary and tt.whitespaces_before_count == 1): 
                            ...
                            nex = PersonItemToken.__try_attach(npt.end_token, attrs, None)
            ...
            for wf in tt.morph.items: 
                if (not wf.class0_.is_verb): 
                    if (wf.contains_attr("к.ф.", None)): 
                        continue
                    if (wf.case_.is_genitive and wf.number == MorphNumber.PLURAL and tt.term.endswith("ОВ")): 
                        res.lastname.vars0_.clear()
                        res.lastname.vars0_.append(PersonItemToken.MorphPersonItemVariant(tt.term, MorphBaseInfo._new3119(MorphGender.MASCULINE, MorphCase.NOMINATIVE), True))
                        res.lastname.is_lastname_has_std_tail = True
                        break
                ...
                if (g != MorphGender.MASCULINE and g != MorphGender.FEMINIE): 
                    ...
                    for kp in di: 
                        if (fi): 
                            ...
                            mi = MorphBaseInfo._new3145(kp.gender)
                            res.firstname.vars0_.append(PersonItemToken.MorphPersonItemVariant._new3199(kp.name, mi, False, val))
                else: 
                    cou = 0
                    for kp in di: 
                        if (kp.gender == g): 
                            ...
                            if (cou < 2): 
                                ...
                                res.firstname.vars0_.insert(i + 1, PersonItemToken.MorphPersonItemVariant._new3199(kp.name, res.firstname.vars0_[i], False, val))
            ...
            if (ter in PersonItemToken.M_ARAB_POSTFIX or ter in PersonItemToken.M_ARAB_POSTFIX_FEM): 
                ...
                if ((((ter == "ОГЛЫ" or ter == "ОГЛИ" or ter == "КЫЗЫ") or ter == "ГЫЗЫ" or ter == "УГЛИ") or ter == "КЗЫ" or ter == "УЛЫ") or ter == "УУЛУ"): 
                    if (res.middlename is not None): 
                        res.firstname = (None)
                        res.lastname = (None)
            elif ((not res.is_whitespace_after and not res.end_token.next0_.is_whitespace_after and res.end_token.next0_.next0_.chars.equals(res.begin_token.chars)) and res.begin_token == res.end_token): 
                res1 = PersonItemToken.try_attach(res.end_token.next0_.next0_, PersonItemToken.ParseAttr.NO, None)
    ...
    def try_attach_list(t : 'Token', attrs : 'ParseAttr'=ParseAttr.NO, max_count : int=10) -> typing.List['PersonItemToken']:
        ...
        if (((not (isinstance(t, TextToken)) or not t.chars.is_letter)) and (((attrs) & (PersonItemToken.ParseAttr.CANINITIALBEDIGIT))) == (PersonItemToken.ParseAttr.NO)): 
            if ((isinstance(t, ReferentToken)) and (((isinstance(t.get_referent(), GeoReferent)) or t.get_referent().type_name == "ORGANIZATION" or t.get_referent().type_name == "TRANSPORT"))): 
                ...
                return None
        pit = PersonItemToken.try_attach(t, attrs, None)
        ...
        if ((t is not None and t.is_char('.') and pit.typ == PersonItemToken.ItemType.VALUE) and pit.length_char > 3): 
            ...
            if (str.isupper(str0_[0]) and str.isupper(str0_[len(str0_) - 1])): 
                ...
                if (ok): 
                    ...
                    pit2 = PersonItemToken._new3146(t, t, PersonItemToken.ItemType.INITIAL, str0_[len(str0_) - 1:])
                    res.append(pit2)
                    t = t.next0_
        zap = False
        while t is not None: 
            if (t.whitespaces_before_count > 15): 
                if (t.whitespaces_before_count > 30): 
                    break
                if ((((attrs) & (PersonItemToken.ParseAttr.MUSTBEITEMALWAYS))) == (PersonItemToken.ParseAttr.NO)): 
                    break
            tt = t
            if (tt.is_hiphen and tt.next0_ is not None): 
                if (not tt.is_whitespace_after and not tt.is_whitespace_before): 
                    tt = t.next0_
                elif (tt.previous.chars.equals(tt.next0_.chars) and not tt.is_newline_after): 
                    tt = tt.next0_
            elif ((tt.is_char(',') and (tt.whitespaces_after_count < 2) and tt.next0_ is not None) and len(res) == 1): 
                zap = True
                tt = tt.next0_
            elif ((tt.is_char('(') and (isinstance(tt.next0_, TextToken)) and tt.next0_.chars.equals(tt.previous.chars)) and tt.next0_.next0_ is not None and tt.next0_.next0_.is_char(')')): 
                pit0 = res[len(res) - 1]
                pit11 = PersonItemToken.try_attach(tt.next0_, attrs, None)
                if (pit0.firstname is not None and pit11 is not None and pit11.firstname is not None): 
                    ...
                    pit0.end_token = tt
                    tt = tt.next0_
                elif (pit0.firstname is None and pit0.lastname is not None and ((pit0.lastname.is_in_dictionary or pit0.lastname.is_lastname_has_std_tail or pit0.lastname.is_has_std_postfix))): 
                    if (pit11 is not None and pit11.lastname is not None): 
                        ...
                        if ((pit11.lastname.is_in_dictionary or pit11.lastname.is_lastname_has_std_tail or pit11.lastname.is_has_std_postfix)): 
                            ...
                            pit22 = PersonItemToken.try_attach(tt.next0_.next0_.next0_, attrs, None)
                        ...
                        if (ok): 
                            ...
                            pit0.end_token = tt
                            tt = tt.next0_
            pit1 = PersonItemToken.try_attach(tt, attrs, res)
            if (pit1 is None): 
                break
                ...
                if (pit1.typ == PersonItemToken.ItemType.INITIAL): 
                    if (pit1.chars.is_cyrillic_letter): 
                        ...
                        if (v != (chr(0))): 
                            pit1.value = "{0}".format(v)
                            ok = True
                            pit1.chars = CharsInfo._new3165(True)
                        elif (pit.typ == PersonItemToken.ItemType.INITIAL): 
                            v = LanguageHelper.get_lat_for_cyr(pit.value[0])
                            if (v != (chr(0))): 
                                pit.value = "{0}".format(v)
                                ok = True
                                pit.chars = CharsInfo._new3202(True)
                                pit = pit1
                elif (pit.typ == PersonItemToken.ItemType.INITIAL): 
            ...
            if (pit1.typ == PersonItemToken.ItemType.VALUE or ((pit1.typ == PersonItemToken.ItemType.SUFFIX and pit1.is_newline_before))): 
                if ((((attrs) & (PersonItemToken.ParseAttr.IGNOREATTRS))) == (PersonItemToken.ParseAttr.NO)): 
                    pat = PersonAttrToken.try_attach(pit1.begin_token, PersonAttrToken.PersonAttrAttachAttrs.NO)
                    if (pat is not None): 
        ...
        if (len(res) == 1 and res[0].is_newline_before and res[0].is_newline_after): 
            if (res[0].lastname is not None and ((res[0].lastname.is_has_std_postfix or res[0].lastname.is_in_dictionary or res[0].lastname.is_lastname_has_std_tail))): 
                res1 = PersonItemToken.try_attach_list(res[0].end_token.next0_, PersonItemToken.ParseAttr.CANBELATIN, max_count)
                if (res1 is not None and len(res1) > 0): 
                    if (len(res1) == 2 and ((res1[0].firstname is not None or res1[1].middlename is not None)) and res1[1].is_newline_after): 
                        ...
                        res2 = PersonItemToken.try_attach_list(res1[0].end_token.next0_, PersonItemToken.ParseAttr.CANBELATIN, max_count)
        ...
        while True:
            ...
            if (res[i].firstname is not None and res[i].begin_token.is_value("СВЕТА", None)): 
                ...
                if (res[i].lastname is None): 
                    res[i].lastname = PersonItemToken.MorphPersonItem._new3144(True)
        ...
        while True:
            ...
            if (res[i].typ == PersonItemToken.ItemType.VALUE and res[i + 1].typ == PersonItemToken.ItemType.VALUE and res[i].end_token.next0_.is_hiphen): 
                ...
                del res[i + 1]
                break
        if (len(res) == 1 and res[0].length_char == 1): 
            return None
        if (((len(res) >= 4 and res[0].typ == PersonItemToken.ItemType.INITIAL and res[1].typ == PersonItemToken.ItemType.INITIAL) and res[0].value == "М" and res[1].value == "П") and res[2].typ != PersonItemToken.ItemType.INITIAL): 
            del res[0]
            del res[0]
        return res
    ...
    def try_parse_person(t : 'Token', prev_pers_template : 'FioTemplateType'=FioTemplateType.UNDEFINED) -> 'ReferentToken':
        ...
        if (isinstance(t.get_referent(), PersonReferent)): 
            ...
            if (rt.begin_token == rt.end_token): 
                ...
                if (tt1 is not None and (tt1.whitespaces_before_count < 2)): 
                    pits0 = PersonItemToken.try_attach_list(tt1, PersonItemToken.ParseAttr.CANINITIALBEDIGIT, 10)
                    if (pits0 is not None and pits0[0].typ == PersonItemToken.ItemType.INITIAL): 
                        ...
                        if (str0_ is not None and str0_.startswith(pits0[0].value)): 
                            res = ReferentToken._new3207(rt.referent, t, pits0[0].end_token, FioTemplateType.SURNAMEI)
                    ...
                    if (((((isinstance(tt1, TextToken)) and tt1.length_char == 1 and tt1.chars.is_all_upper) and tt1.chars.is_cyrillic_letter and (isinstance(tt1.next0_, TextToken))) and (tt1.whitespaces_after_count < 2) and tt1.next0_.length_char == 1) and tt1.next0_.chars.is_all_upper and tt1.next0_.chars.is_cyrillic_letter): 
                        ...
                        if (str0_ is not None and str0_.startswith(tt1.term)): 
                            ...
                            if (str2 is None or str2.startswith(tt1.next0_.term)): 
                                res = ReferentToken._new3207(rt.referent, t, tt1.next0_, FioTemplateType.NAMEISURNAME)
                                if (str2 is None): 
        ...
        if (t.get_referent() is not None and t.get_referent().type_name == "ORGANIZATION"): 
            ...
            if (ppp is not None and ppp.end_char == rt.end_char): 
                ...
                return ppp
        pits = PersonItemToken.try_attach_list(t, Utils.valToEnum((PersonItemToken.ParseAttr.CANINITIALBEDIGIT) | (PersonItemToken.ParseAttr.CANBELATIN), PersonItemToken.ParseAttr), 10)
        if ((pits is None and (isinstance(t, TextToken)) and t.chars.is_all_lower) and t.length_char > 3): 
            pi0_ = PersonItemToken.try_attach(t, Utils.valToEnum((PersonItemToken.ParseAttr.CANINITIALBEDIGIT) | (PersonItemToken.ParseAttr.CANBELATIN) | (PersonItemToken.ParseAttr.CANBELOWER), PersonItemToken.ParseAttr), None)
            if (pi0_ is not None and pi0_.lastname is not None and ((pi0_.lastname.is_in_dictionary or pi0_.lastname.is_lastname_has_std_tail))): 
                pits = PersonItemToken.try_attach_list(pi0_.end_token.next0_, Utils.valToEnum((PersonItemToken.ParseAttr.CANINITIALBEDIGIT) | (PersonItemToken.ParseAttr.CANBELATIN), PersonItemToken.ParseAttr), 10)
        ...
        if (pits is not None and prev_pers_template != FioTemplateType.UNDEFINED and pits[0].typ == PersonItemToken.ItemType.VALUE): 
            ...
            if (((isinstance(tt1, TextToken)) and tt1.chars.is_letter and tt1.chars.is_all_upper) and tt1.length_char == 1 and (tt1.whitespaces_before_count < 2)): 
                ii = PersonItemToken._new3148(tt1, tt1, PersonItemToken.ItemType.INITIAL, tt1.term, tt1.chars)
                pits.append(ii)
            if (len(pits) == 1 and pits[0].is_newline_after and ((prev_pers_template == FioTemplateType.SURNAMEI or prev_pers_template == FioTemplateType.SURNAMEII))): 
                ppp = PersonItemToken.try_attach_list(pits[0].end_token.next0_, PersonItemToken.ParseAttr.CANBELATIN, 10)
        ...
        if (pits is not None and len(pits) > 1): 
            ...
            if (pits[0].typ == PersonItemToken.ItemType.VALUE and pits[1].typ == PersonItemToken.ItemType.INITIAL): 
                if (((t.is_value("ГЛАВА", None) or t.is_value("СТАТЬЯ", "СТАТТЯ") or t.is_value("РАЗДЕЛ", "РОЗДІЛ")) or t.is_value("ПОДРАЗДЕЛ", "ПІДРОЗДІЛ") or t.is_value("ЧАСТЬ", "ЧАСТИНА")) or t.is_value("ПРИЛОЖЕНИЕ", "ДОКЛАДАННЯ")): 
                    return None
                if (((t.is_value("CHAPTER", None) or t.is_value("CLAUSE", None) or t.is_value("SECTION", None)) or t.is_value("SUBSECTION", None) or t.is_value("PART", None)) or t.is_value("LIST", None) or t.is_value("APPENDIX", None)): 
                    return None
                first = pits[1]
                last = pits[0]
        ...
        if (pits is not None and len(pits) == 1 and pits[0].typ == PersonItemToken.ItemType.VALUE): 
            ...
            if (((isinstance(tt, TextToken)) and tt.length_char == 2 and tt.chars.is_all_upper) and tt.chars.is_cyrillic_letter): 
                ...
                res = ReferentToken._new3207(pers, t, tt, FioTemplateType.SURNAMEII)
                if (tt.next0_ is not None and tt.next0_.is_char('.')): 
                    tt = tt.next0_
                    res.end_token = tt
                res.data = t.kit.get_analyzer_data_by_analyzer_name(PersonAnalyzer.ANALYZER_NAME)
            ...
            if ((((((isinstance(tt, TextToken)) and (tt.whitespaces_before_count < 2) and tt.length_char == 1) and tt.chars.is_all_upper and tt.chars.is_cyrillic_letter) and (isinstance(tt.next0_, TextToken)) and (tt.whitespaces_after_count < 2)) and tt.next0_.length_char == 1 and tt.next0_.chars.is_all_upper) and tt.next0_.chars.is_cyrillic_letter): 
                ...
                res = ReferentToken._new3207(pers, t, tt.next0_, FioTemplateType.SURNAMEII)
            ...
            if (comma and tt is not None and (tt.whitespaces_before_count < 2)): 
                pits1 = PersonItemToken.try_attach_list(tt, Utils.valToEnum((PersonItemToken.ParseAttr.CANINITIALBEDIGIT) | (PersonItemToken.ParseAttr.CANBELATIN), PersonItemToken.ParseAttr), 10)
                if (pits1 is not None and len(pits1) > 0 and pits1[0].typ == PersonItemToken.ItemType.INITIAL): 
                    ...
                    res = ReferentToken._new3207(pers, t, pits1[0].end_token, FioTemplateType.SURNAMEI)
    ...
    @staticmethod
    def _new3146(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str) -> 'PersonItemToken':
    ...
    @staticmethod
    def _new3148(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : 'CharsInfo') -> 'PersonItemToken':
        res = PersonItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.chars = _arg5
    ...
    @staticmethod
    def _new3154(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'PersonReferent', _arg5 : 'MorphCollection') -> 'PersonItemToken':
        res = PersonItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.referent = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new3162(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : 'CharsInfo') -> 'PersonItemToken':
        res = PersonItemToken(_arg1, _arg2)
        res.value = _arg3
        res.chars = _arg4
        return res
    ...
    @staticmethod
    def _new3177(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str) -> 'PersonItemToken':
        res = PersonItemToken(_arg1, _arg2)
        res.value = _arg3
        return res
    
    @staticmethod
    def _new3178(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : 'ItemType') -> 'PersonItemToken':
        res = PersonItemToken(_arg1, _arg2)
        res.value = _arg3
        res.typ = _arg4
        return res
    ...
    @staticmethod
    def _new3179(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : 'CharsInfo', _arg5 : 'MorphCollection') -> 'PersonItemToken':
        res = PersonItemToken(_arg1, _arg2)
        res.value = _arg3
        res.chars = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _static_ctor():
        PersonItemToken.M_SUR_PREFIXES = list(["АБД", "АБУ", "АБУЛЬ", "АБДУ", "АБДЕЛЬ", "УММ", "АЛ", "АЛЬ", "АН", "АТ", "АР", "АС", "АД", "БИН", "БЕН", "ИБН", "УЛЬД", "БИНТ", "ФОН", "ВАН", "ДЕ", "ДИ", "ДА", "ЛА", "ЛЕ", "ЛЯ", "ЭЛЬ", "УЛЬ"])
        PersonItemToken.M_SUR_PREFIXES_LAT = list(["ABD", "AL", "BEN", "IBN", "VON", "VAN", "DE", "DI", "LA", "LE", "DA", "DE"])
        PersonItemToken.M_ARAB_POSTFIX = list(["АГА", "АЛИ", "АР", "АС", "АШ", "БЕЙ", "БЕК", "ЗАДЕ", "ОГЛЫ", "ОГЛИ", "УГЛИ", "ОЛЬ", "ООЛ", "ПАША", "БАША", "УЛЬ", "УЛЫ", "УУЛУ", "ХАН", "ХАДЖИ", "ШАХ", "ЭД", "ЭЛЬ"])
