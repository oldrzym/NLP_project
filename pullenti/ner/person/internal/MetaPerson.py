...
class MetaPerson(ReferentClass):
    ...
    def initialize() -> None:
        ...
        MetaPerson._global_meta.add_feature(PersonReferent.ATTR_UNDEFNAME, "Непонятно что", 0, 0)
        MetaPerson._global_meta.add_feature(PersonReferent.ATTR_NAMETYPE, "Тип именования", 0, 0)
