...
class MoneyReferent(Referent):
    ...
    def value(self) -> float:
        ...
        if (val is None): 
            return 0
        v = 0
        wrapv2281 = RefOutArgWrapper(0)
        inoutres2282 = Utils.tryParseFloat(val, wrapv2281)
        v = wrapv2281.value
        if (not inoutres2282): 
            return 0
        return v
    ...
    def alt_value(self) -> float:
        ...
        if (val is None): 
            return None
        v = 0
        wrapv2283 = RefOutArgWrapper(0)
        inoutres2284 = Utils.tryParseFloat(val, wrapv2283)
        v = wrapv2283.value
        if (not inoutres2284): 
            return None
        return v
    ...
    def rest(self) -> int:
        ...
        if (val is None): 
            return 0
        v = 0
        wrapv2285 = RefOutArgWrapper(0)
        inoutres2286 = Utils.tryParseInt(val, wrapv2285)
        v = wrapv2285.value
        if (not inoutres2286): 
            return 0
        return v
    ...
    def alt_rest(self) -> int:
        ...
        if (val is None): 
            return None
        v = 0
        wrapv2287 = RefOutArgWrapper(0)
        inoutres2288 = Utils.tryParseInt(val, wrapv2287)
        v = wrapv2287.value
        if (not inoutres2288): 
            return None
        return v
    ...
    @staticmethod
    def _new1042(_arg1 : str, _arg2 : float) -> 'MoneyReferent':
        res = MoneyReferent()
        res.currency = _arg1
