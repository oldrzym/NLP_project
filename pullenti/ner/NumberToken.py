...
class NumberToken(MetaToken):
    ...
    def value(self, value_) -> str:
        ...
        n = 0
        wrapn3481 = RefOutArgWrapper(0)
        inoutres3482 = Utils.tryParseInt(self.__m_value, wrapn3481)
        n = wrapn3481.value
        if (inoutres3482): 
            self.__m_int_val = n
        else: 
    ...
    @staticmethod
    def _new639(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : 'NumberSpellingType', _arg5 : 'MorphCollection') -> 'NumberToken':
