...
class BookLinkRefReferent(Referent):
    ...
    def to_string_ex(self, short_variant : bool, lang : 'MorphLang'=None, lev : int=0) -> str:
        ...
        if (book_ is None): 
            ...
            print(book_.to_string_ex(short_variant, lang, lev), end="", file=res)
    ...
    def get_number_diff(r1 : 'Referent', r2 : 'Referent') -> int:
        ...
        n1 = 0
        n2 = 0
        wrapn1507 = RefOutArgWrapper(0)
        inoutres508 = Utils.tryParseInt(num1, wrapn1507)
        wrapn2509 = RefOutArgWrapper(0)
        inoutres510 = Utils.tryParseInt(num2, wrapn2509)
        n1 = wrapn1507.value
        n2 = wrapn2509.value
        if (not inoutres508 or not inoutres510): 
            return None
        return n2 - n1
    
    @staticmethod
    def _new498(_arg1 : 'Referent') -> 'BookLinkRefReferent':
