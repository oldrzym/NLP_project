...
class MetaDate(ReferentClass):
    ...
    def initialize() -> None:
        ...
        MetaDate.GLOBAL_META.add_feature(DateReferent.ATTR_DECADE, "Декада", 0, 1)
        MetaDate.GLOBAL_META.add_feature(DateReferent.ATTR_YEAR, "Год", 0, 1)
        MetaDate.GLOBAL_META.add_feature(DateReferent.ATTR_HALFYEAR, "Полугодие", 0, 1)
        MetaDate.GLOBAL_META.add_feature(DateReferent.ATTR_QUARTAL, "Квартал", 0, 1)
        MetaDate.GLOBAL_META.add_feature(DateReferent.ATTR_SEASON, "Сезон", 0, 1)
        ...
        MetaDate.GLOBAL_META.add_feature(DateReferent.ATTR_NEWSTYLE, "Дата нового стиля", 0, 1)
