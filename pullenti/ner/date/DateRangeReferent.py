...
class DateRangeReferent(Referent):
    ...
    def calculate_date_range(self, now : datetime.datetime, from0_ : datetime.datetime, to : datetime.datetime, tense : int=0) -> bool:
        ...
        inoutres982 = DateRelHelper.calculate_date_range2(self, now, from0_, to, tense)
        return inoutres982
    ...
    @staticmethod
    def _new895(_arg1 : 'DateReferent', _arg2 : 'DateReferent') -> 'DateRangeReferent':
    ...
    @staticmethod
    def _new901(_arg1 : 'DateReferent') -> 'DateRangeReferent':
        res = DateRangeReferent()
        res.date_to = _arg1
        return res
    
    @staticmethod
    def _new902(_arg1 : 'DateReferent') -> 'DateRangeReferent':
        res = DateRangeReferent()
        res.date_from = _arg1
        return res