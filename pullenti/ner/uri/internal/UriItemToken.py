...
class UriItemToken(MetaToken):
    ...
    def attachisocontent(t0 : 'Token', spec_chars : str) -> 'UriItemToken':
        ...
        first_pass4107 = True
        while True:
            if first_pass4107: first_pass4107 = False
            else: t = t.next0_
        ...
        if (txt.tell() == 0): 
            return None
        return UriItemToken._new3337(t0, t1, Utils.toStringStringIO(txt))
    ...
    def __attach_uri_content(t0 : 'Token', chars_ : str, can_be_whitespaces : bool=False) -> 'UriItemToken':
        ...
        first_pass4108 = True
        while True:
            if first_pass4108: first_pass4108 = False
            else: t = t.next0_
            if (not (t is not None)): break
            if (t != t0 and t.is_whitespace_before): 
                ...
                if (t.previous.is_hiphen): 
                    ...
                    first_pass4109 = True
                    while True:
                        if first_pass4109: first_pass4109 = False
                        else: tt1 = tt1.next0_
        ...
        if (Utils.compareStrings(tmp, "WWW", True) == 0): 
            return None
        res = UriItemToken._new3337(t0, t1, Utils.toStringStringIO(txt))
        return res
    ...
    def attach_domain_name(t0 : 'Token', check_ : bool, can_be_whitspaces : bool) -> 'UriItemToken':
        ...
        first_pass4110 = True
        while True:
            if first_pass4110: first_pass4110 = False
            else: t = t.next0_
            if (not (t is not None)): break
            if (t.is_whitespace_before and t != t0): 
                ...
                if (not t.is_newline_before and can_be_whitspaces): 
                    ...
                    first_pass4111 = True
                    while True:
                        if first_pass4111: first_pass4111 = False
                        else: tt1 = tt1.next0_
                        if (not (tt1 is not None)): break
            ...
            if (not str.isalpha(ch)): 
                ...
                if (ch == '-'): 
                    if (Utils.compareStrings(Utils.toStringStringIO(txt), "vk.com", True) == 0): 
                        return UriItemToken._new3337(t0, t1, Utils.toStringStringIO(txt).lower())
            else: 
                is_ip = False
    ...
    def attach_mail_users(t1 : 'Token') -> typing.List['UriItemToken']:
        ...
        if (t1.is_char('}')): 
            ...
            first_pass4112 = True
            while True:
                if first_pass4112: first_pass4112 = False
                else: t1 = t1.previous
        ...
        first_pass4113 = True
        while True:
            if first_pass4113: first_pass4113 = False
            else: t = t.previous
            if (not (t is not None)): break
        ...
        if (txt.tell() == 0): 
            return None
        res = list()
        res.append(UriItemToken._new3337(t0, t1, Utils.toStringStringIO(txt).lower()))
        return res
    ...
    def attachisbn(t0 : 'Token') -> 'UriItemToken':
        ...
        first_pass4114 = True
        while True:
            if first_pass4114: first_pass4114 = False
            else: t = t.next0_
            if (not (t is not None)): break
    ...
    def attachbbk(t0 : 'Token') -> 'UriItemToken':
        ...
        first_pass4115 = True
        while True:
            if first_pass4115: first_pass4115 = False
            else: t = t.next0_
            if (not (t is not None)): break
            if (t.is_newline_before and t != t0): 
                break
    ...
    @staticmethod
    def _new3337(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str) -> 'UriItemToken':
