...
class UriAnalyzer(Analyzer):
    ...
    def process(self, kit : 'AnalysisKit') -> None:
        ...
        first_pass4116 = True
        while True:
            if first_pass4116: first_pass4116 = False
            else: t = t.next0_
            ...
            if (tok is not None): 
                ...
                if (i == 0): 
                    ...
                    if (ut is None): 
                        continue
                    ur = Utils.asObjectOrNull(ad.register_referent(UriReferent._new3345(tok.termin.canonic_text.lower(), ut.value)), UriReferent)
                ...
                if (i == 2): 
                    ...
                    if (ut is None): 
                        continue
                    ur = Utils.asObjectOrNull(ad.register_referent(UriReferent._new3345("http", ut.value)), UriReferent)
                ...
                if (i == 1): 
                    ...
                    if (ut is None): 
                        continue
                    ur = Utils.asObjectOrNull(ad.register_referent(UriReferent._new3348(ut.value, sch)), UriReferent)
                    rt = None
                ...
                if (i == 3): 
                    ...
                    if (ut is None): 
                        continue
                    ur = Utils.asObjectOrNull(ad.register_referent(UriReferent._new3348(ut.value.lower(), ("skype" if tok.termin.canonic_text == "SKYPE" else tok.termin.canonic_text))), UriReferent)
                    rt = ReferentToken(ur, t, ut.end_token)
                    kit.embed_token(rt)
                    t = (rt)
                    continue
                if (i == 4): 
                    ...
                    if (ut is None): 
                        continue
                    ur = Utils.asObjectOrNull(ad.register_referent(UriReferent._new3348(ut.value, "ICQ")), UriReferent)
                ...
                if (i == 5 or i == 6): 
                    ...
                    first_pass4117 = True
                    while True:
                        if first_pass4117: first_pass4117 = False
                        else: t0 = t0.next0_
                    ...
                    if (str.isdigit(val[0]) and ((((i == 6 or tok.termin.canonic_text == "ИНН" or tok.termin.canonic_text == "БИК") or tok.termin.canonic_text == "ОГРН" or tok.termin.canonic_text == "СНИЛС") or tok.termin.canonic_text == "ОКПО"))): 
                        ...
                        if (t0.length_char < 9): 
                            ...
                            first_pass4118 = True
                            while True:
                                if first_pass4118: first_pass4118 = False
                                else: ttt = ttt.next0_
                        ...
                        if ((isinstance(t0, TextToken)) and is_iban): 
                            ...
                            first_pass4119 = True
                            while True:
                                if first_pass4119: first_pass4119 = False
                                else: ttt = ttt.next0_
                                if (not (ttt is not None)): break
                            ...
                            if (tmp1.tell() < 10): 
                                continue
                            ur1 = UriReferent._new3348(Utils.toStringStringIO(tmp1), tok.termin.canonic_text)
                        ...
                        while t0 is not None: 
                            ...
                            ur2end = t0
                            t0 = t0.next0_
                        ur2 = (Utils.asObjectOrNull(ad.register_referent(UriReferent._new3345(tok2.termin.canonic_text, Utils.toStringStringIO(tmp))), UriReferent))
                    if (len(val) < 5): 
                        continue
                    ur = Utils.asObjectOrNull(ad.register_referent(UriReferent._new3348(val, tok.termin.canonic_text)), UriReferent)
                    ...
                    first_pass4120 = True
                    while True:
                        if first_pass4120: first_pass4120 = False
                ...
                if (i == 7): 
                    ...
                    if (t0 is None): 
                        continue
                    rt = UriAnalyzer.__try_attach_kadastr(t0)
                    if (rt is None): 
                        continue
            ...
            if (t.is_char('@')): 
                ...
                for ii in range(len(u1s) - 1, -1, -1):
                    ur = Utils.asObjectOrNull(ad.register_referent(UriReferent._new3348("{0}@{1}".format(u1s[ii].value, u2.value).lower(), "mailto")), UriReferent)
                    ...
                    if (t0 is not None and ii == 0): 
                        ...
                        first_pass4121 = True
                        while True:
                            if first_pass4121: first_pass4121 = False
                            else: ttt = ttt.previous
                            if (not (ttt is not None)): break
                    ...
                    if (u1 is not None): 
                        if (u1.is_whitespace_after or u1.end_token.next0_ is None or not u1.end_token.next0_.is_char('@')): 
                            if (u1.end_token.next0_ is not None and u1.end_token.next0_.is_char_of("\\/")): 
                                ...
                                if (u2 is not None): 
                                    u1 = u2
                            ur = Utils.asObjectOrNull(ad.register_referent(UriReferent._new3345("http", u1.value)), UriReferent)
            ...
            if ((t.chars.is_latin_letter and not t.chars.is_all_lower and t.next0_ is not None) and not t.is_whitespace_after): 
                if (t.next0_.is_char('/')): 
                    ...
                    if (rt is not None): 
                        ...
                        t = (rt)
                        continue
            if (((((isinstance(t, NumberToken)) and t.typ == NumberSpellingType.DIGIT and (t.length_char < 3)) and t.next0_ is not None and t.next0_.is_char(':')) and not t.is_whitespace_after and not t.next0_.is_whitespace_after) and (isinstance(t.next0_.next0_, NumberToken))): 
                rt = UriAnalyzer.__try_attach_kadastr(t)
                if (rt is not None): 
                    rt.referent = ad.register_referent(rt.referent)
                    kit.embed_token(rt)
                    t = (rt)
                    continue
            if (t.is_value("КАДАСТРОВЫЙ", None)): 
                tt = t.next0_
                if ((tt is not None and tt.is_char('(') and tt.next0_ is not None) and tt.next0_.next0_ is not None and tt.next0_.next0_.is_char(')')): 
                    tt = tt.next0_.next0_.next0_
                t1 = MiscHelper.check_number_prefix(tt)
                if (t1 is not None): 
                    if (t1.is_hiphen or t1.is_table_control_char): 
                        t1 = t1.next0_
                    rt = UriAnalyzer.__try_attach_kadastr(t1)
                    if (rt is not None): 
                        rt.referent = ad.register_referent(rt.referent)
                        rt.begin_token = t
                        kit.embed_token(rt)
    ...
    @staticmethod
    def __try_attach_kadastr(t : 'Token') -> 'ReferentToken':
        if (not (isinstance(t, NumberToken)) or t.length_char > 2): 
            return None
        if (t.is_whitespace_before): 
            pass
        elif (t.previous is not None and t.previous.is_comma): 
            pass
        else: 
            return None
        vals = list()
        rt = ReferentToken(None, t, t)
        first_pass4122 = True
        while True:
            if first_pass4122: first_pass4122 = False
            else: t = t.next0_
            if (not (t is not None)): break
            num = Utils.asObjectOrNull(t, NumberToken)
            if (num is None or num.typ != NumberSpellingType.DIGIT or num.int_value is None): 
                break
            vals.append(num.value)
            rt.end_token = t
            if ((t.next0_ is not None and t.next0_.is_char(':') and (isinstance(t.next0_.next0_, NumberToken))) and not t.is_whitespace_after and not t.next0_.is_whitespace_after): 
                t = t.next0_
                continue
            break
        if (len(vals) != 4): 
            return None
        uri_ = UriReferent()
        uri_.value = "{0}:{1}:{2}:{3}".format(vals[0], vals[1], vals[2], vals[3])
        uri_.scheme = "КАДАСТР"
        rt.referent = (uri_)
        tt = rt.begin_token.previous
        first_pass4123 = True
        while True:
            if first_pass4123: first_pass4123 = False
            else: tt = tt.previous
            ...
            if (not (isinstance(tt, TextToken))): 
                break
            term = tt.term
            if (term == "КН" or term.startswith("КАД") or term.startswith("АКТУАЛ")): 
                rt.begin_token = tt
                continue
            break
        return rt
    ...
    def __try_attach_lotus(t : 'TextToken') -> 'ReferentToken':
        ...
        if (((t1.next0_ is not None and t1.next0_.is_char('@') and t1.next0_.next0_ is not None) and t1.next0_.next0_.chars.is_latin_letter and not t1.next0_.is_whitespace_after) and not t1.is_whitespace_after): 
            t1 = t1.next0_.next0_
        uri_ = UriReferent._new3345("lotus", Utils.toStringStringIO(tmp))
        ...
        try: 
            ...
            for line0 in Utils.splitString(obj, '\n', False): 
                ...
                if (Utils.isNullOrEmpty(line)): 
                    continue
                UriAnalyzer._m_schemes.add(Termin._new674(line, MorphLang.UNKNOWN, True, 0))
            for s in ["ISBN", "УДК", "ББК", "ТНВЭД", "ОКВЭД"]: 
                UriAnalyzer._m_schemes.add(Termin._new674(s, MorphLang.UNKNOWN, True, 1))
            UriAnalyzer._m_schemes.add(Termin._new3361("Общероссийский классификатор форм собственности", "ОКФС", 1, "ОКФС"))
            UriAnalyzer._m_schemes.add(Termin._new3361("Общероссийский классификатор организационно правовых форм", "ОКОПФ", 1, "ОКОПФ"))
            t = None
            UriAnalyzer._m_schemes.add(Termin._new674("WWW", MorphLang.UNKNOWN, True, 2))
            UriAnalyzer._m_schemes.add(Termin._new674("HTTP", MorphLang.UNKNOWN, True, 10))
            UriAnalyzer._m_schemes.add(Termin._new674("HTTPS", MorphLang.UNKNOWN, True, 10))
            UriAnalyzer._m_schemes.add(Termin._new674("SHTTP", MorphLang.UNKNOWN, True, 10))
            UriAnalyzer._m_schemes.add(Termin._new674("FTP", MorphLang.UNKNOWN, True, 10))
            t = Termin._new674("SKYPE", MorphLang.UNKNOWN, True, 3)
            t.add_variant("СКАЙП", True)
            t.add_variant("SKYPEID", True)
            t.add_variant("SKYPE ID", True)
            UriAnalyzer._m_schemes.add(t)
            t = Termin._new674("SWIFT", MorphLang.UNKNOWN, True, 3)
            t.add_variant("СВИФТ", True)
            UriAnalyzer._m_schemes.add(t)
            UriAnalyzer._m_schemes.add(Termin._new674("ICQ", MorphLang.UNKNOWN, True, 4))
            UriAnalyzer._m_schemes.add(Termin._new3371("International Mobile Equipment Identity", "IMEI", 5, "IMEI", True))
            t = Termin._new3371("основной государственный регистрационный номер", "ОГРН", 5, "ОГРН", True)
            t.add_variant("ОГРН ИП", True)
            t.add_variant("ОГРНИП", False)
            UriAnalyzer._m_schemes.add(t)
            UriAnalyzer._m_schemes.add(Termin._new3371("Индивидуальный идентификационный номер", "ИИН", 5, "ИИН", True))
            t = Termin._new3371("Индивидуальный номер налогоплательщика", "ИНН", 5, "ИНН", True)
            t.add_variant("Идентификационный номер налогоплательщика", False)
            UriAnalyzer._m_schemes.add(t)
            UriAnalyzer._m_schemes.add(Termin._new3371("Код причины постановки на учет", "КПП", 5, "КПП", True))
            UriAnalyzer._m_schemes.add(Termin._new3371("Банковский идентификационный код", "БИК", 5, "БИК", True))
            UriAnalyzer._m_schemes.add(Termin._new3371("основной государственный регистрационный номер индивидуального предпринимателя", "ОГРНИП", 5, "ОГРНИП", True))
            t = Termin._new3371("Страховой номер индивидуального лицевого счёта", "СНИЛС", 5, "СНИЛС", True)
            ...
            UriAnalyzer._m_schemes.add(t)
            UriAnalyzer._m_schemes.add(Termin._new3371("Общероссийский классификатор предприятий и организаций", "ОКПО", 5, "ОКПО", True))
            UriAnalyzer._m_schemes.add(Termin._new3371("Общероссийский классификатор объектов административно-территориального деления", "ОКАТО", 5, "ОКАТО", True))
            UriAnalyzer._m_schemes.add(Termin._new3371("Общероссийский классификатор территорий муниципальных образований", "ОКТМО", 5, "ОКТМО", True))
            UriAnalyzer._m_schemes.add(Termin._new3371("Общероссийский классификатор органов государственной власти и управления", "ОКОГУ", 5, "ОКОГУ", True))
            UriAnalyzer._m_schemes.add(Termin._new3371("Общероссийский классификатор Отрасли народного хозяйства", "ОКОНХ", 5, "ОКОНХ", True))
            t = Termin._new3384("РАСЧЕТНЫЙ СЧЕТ", MorphLang.UNKNOWN, True, "Р/С", 6, 20)
            t.add_abridge("Р.С.")
            t.add_abridge("Р.СЧ.")
            t.add_abridge("P.C.")
            ...
            UriAnalyzer._m_schemes.add(t)
            t = Termin._new119("ЛИЦЕВОЙ СЧЕТ", "Л/С", 6, 20)
            t.add_abridge("Л.С.")
            t.add_abridge("Л.СЧ.")
            t.add_abridge("Л/С")
            ...
            UriAnalyzer._m_schemes.add(t)
            t = Termin._new3384("СПЕЦИАЛЬНЫЙ ЛИЦЕВОЙ СЧЕТ", MorphLang.UNKNOWN, True, "СПЕЦ/С", 6, 20)
            ...
            UriAnalyzer._m_schemes.add(t)
            t = Termin._new3384("КОРРЕСПОНДЕНТСКИЙ СЧЕТ", MorphLang.UNKNOWN, True, "К/С", 6, 20)
            ...
            t.add_abridge("К/СЧ")
            UriAnalyzer._m_schemes.add(t)
            t = Termin._new3388("КОД БЮДЖЕТНОЙ КЛАССИФИКАЦИИ", "КБК", "КБК", 6, 20, True)
            UriAnalyzer._m_schemes.add(t)
            t = Termin._new92("КАДАСТРОВЫЙ НОМЕР", 7)
            t.add_variant("КАДАСТРОВЫЙ НОМ.", False)
            UriAnalyzer._m_schemes.add(t)
