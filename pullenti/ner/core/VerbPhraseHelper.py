        ...
        while True:
            ...
            if (tt.term == "НЕТ"): 
                ...
                if (mc.is_preposition or mc.is_misc or mc.is_pronoun): 
                    ...
                    if ((tt.term == "СТАЛИ" or tt.term == "СТЕКЛО" or tt.term == "БЫЛИ") or tt.term == "ДАМ"): 
                        ty = 1
                ...
                if (norm.endswith("ЙШИЙ")): 
                    ...
                    if (grs is not None and len(grs) > 0): 
                        ...
                        for gr in grs: 
                            for w in gr.words: 
                                if (w.class0_ is not None and w.class0_.is_adjective and w.class0_.is_verb): 
                                    if (w.spelling == norm): 
                                        hpart = True
                                elif (w.class0_ is not None and w.class0_.is_verb): 
                                    hverb = True
                        if (hpart and hverb): 
                            ty = 3
            ...
            res.end_token = t
            it = VerbPhraseItemToken._new751(t, t, MorphCollection(t.morph))
            ...
            if (norm is None): 
                ...
                if (ty == 1 and not tt.morph.case_.is_undefined): 
                    mi = MorphWordForm._new752(MorphCase.NOMINATIVE, MorphNumber.SINGULAR, MorphGender.MASCULINE)
