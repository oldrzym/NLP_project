...
class CityItemToken(MetaToken):
            ...
            if (((isinstance(t, TextToken)) and t.is_value("МУНИЦИПАЛЬНЫЙ", None) and t.next0_ is not None) and t.next0_.is_value("ОБРАЗОВАНИЕ", None)): 
                ...
                if (lii is not None and lii[0].typ == CityItemToken.ItemType.NOUN): 
                    ...
                    if (isinstance(t.previous, TextToken)): 
                        if (t.previous.is_value("ГОРОДСКОЙ", None) or t.previous.is_value("СЕЛЬСКИЙ", None)): 
                            lii[0].begin_token = t.previous
                    return lii
            return None
            ...
            if (ci0 is None): 
                ...
                if (ci.typ == CityItemToken.ItemType.NOUN and BracketHelper.can_be_start_of_sequence(t, True, False)): 
                    ...
                    if ((br is not None and (br.length_char < 50) and t.next0_.chars.is_cyrillic_letter) and not t.next0_.chars.is_all_lower): 
                        ci0 = CityItemToken._new1369(br.begin_token, br.end_token, CityItemToken.ItemType.PROPERNAME)
                    ...
                    if (npt is not None): 
                        ...
                        while tt is not None and tt.end_char <= npt.end_char: 
                            ...
                            if (ci00 is not None and ci00.typ == CityItemToken.ItemType.NOUN): 
                                ...
                                if (ci01 is not None): 
                                    break
                                org0_ = OrgItemToken.try_parse(ci00.end_token.next0_, None)
                        ...
                        ci1 = CityItemToken.try_parse(t.next0_, None, False, None)
                        if (ci1 is not None and ci1.typ == CityItemToken.ItemType.NOUN and ((ci1.end_token.next0_ is None or ci1.end_token.next0_.is_comma))): 
                            ci0 = ci1
                if (ci0 is None): 
                    break
    ...
    def try_parse(t : 'Token', prev : 'CityItemToken'=None, dont_normalize : bool=False, ad : 'GeoAnalyzerData'=None) -> 'CityItemToken':
        ...
        if (d is not None and d.no_geo): 
            return None
        if ((isinstance(t, TextToken)) and t.term.startswith("УЧ")): 
            ttt = AddressItemToken.M_PLOT.try_parse(t, TerminParseAttr.NO)
            if (ttt is not None): 
                ok = False
                tt = t.previous
                while tt is not None: 
                    ...
                    tt = tt.previous
                if (ok): 
                    next0__ = CityItemToken.try_parse(ttt.end_token.next0_, None, False, None)
                    if (next0__ is not None and next0__.typ == CityItemToken.ItemType.PROPERNAME): 
                        return CityItemToken._new1370(t, ttt.end_token, CityItemToken.ItemType.NOUN, "участок")
        ...
        if (res is not None and res.typ == CityItemToken.ItemType.NOUN and (res.whitespaces_after_count < 2)): 
            ...
            if (nn is not None and ((nn.end_token.is_value("ЗНАЧЕНИЕ", "ЗНАЧЕННЯ") or nn.end_token.is_value("ТИП", None) or nn.end_token.is_value("ХОЗЯЙСТВО", "ХАЗЯЙСТВО")))): 
                if (nn.begin_token != nn.end_token and ((nn.begin_token.next0_.is_comma_and or OrgTypToken.try_parse(nn.begin_token.next0_, False, None) is not None))): 
                    pass
                elif (OrgItemToken.try_parse(res.end_token.next0_, ad) is None): 
            ...
            if (LanguageHelper.ends_with_ex(res.value, "ГРАД", "ГОРОД", None, None)): 
                ...
                if (LanguageHelper.ends_with_ex(lem, "ГРАД", "ГОРОД", "СК", None) or LanguageHelper.ends_with_ex(lem, "АНЬ", "ПОЛЬ", None, None)): 
                    ...
                    if (not LanguageHelper.ends_with(res.value, "АНЬ")): 
                        res.alt_value = (None)
        if (res is None and t.is_char('(') and MiscLocationHelper.is_user_param_address(t)): 
            next0__ = CityItemToken.try_parse(t.next0_, None, False, None)
            if ((next0__ is not None and next0__.typ == CityItemToken.ItemType.NOUN and next0__.end_token.next0_ is not None) and next0__.end_token.next0_.is_char(')')): 
                next0__.begin_token = t
                next0__.end_token = next0__.end_token.next0_
                res = next0__
        if (res is None): 
            return None
        if (res.typ == CityItemToken.ItemType.NOUN and res.value == "ГОРОДОК"): 
            if (MiscLocationHelper.is_user_param_address(res)): 
                return None
        ...
        if ((res is not None and ((res.typ == CityItemToken.ItemType.CITY or res.typ == CityItemToken.ItemType.PROPERNAME)) and not res.is_whitespace_after) and MiscLocationHelper.is_user_param_address(res)): 
            if (res.end_token.next0_.is_hiphen and (isinstance(res.end_token.next0_.next0_, NumberToken))): 
                res.end_token = res.end_token.next0_.next0_
                res.value = "{0}-{1}".format((res.onto_item.canonic_text if res.onto_item is not None else res.value), res.end_token.value)
    ...
    def __try_parse_int(t : 'Token', prev : 'CityItemToken', dont_normalize : bool, ad : 'GeoAnalyzerData') -> 'CityItemToken':
            ...
            if (res is None): 
                ...
                if (det is not None): 
                    ...
                    while ttt is not None and ttt.end_char <= det.end_char: 
                        ...
                        ttt = ttt.next0_
                    if (cou < 6): 
                        re = CityItemToken._new1369(det.begin_token, det.end_token, CityItemToken.ItemType.PROPERNAME)
        ...
        if (res is not None and res.typ == CityItemToken.ItemType.PROPERNAME and res.begin_token == res.end_token): 
            end = MiscLocationHelper.check_name_long(res)
            if (end is not None): 
                if (CityItemToken.check_keyword(end) is None): 
                    res.end_token = end
        ...
        if (res is None): 
            ...
            if (isinstance(t, TextToken)): 
                ...
                if (txt == "ИМ" or txt == "ИМЕНИ"): 
                    ...
                    if (t1 is not None and t1.is_char('.')): 
                        t1 = t1.next0_
                    nnn = CityItemToken._new1369(t1, t1, CityItemToken.ItemType.NOUN)
                    res = CityItemToken.try_parse(t1, nnn, False, ad)
                    ...
                    if ((t.next0_ is not None and not t.is_whitespace_after and ((t.next0_.is_hiphen or t.next0_.is_char('.')))) and (t.next0_.whitespaces_after_count < 2)): 
                        if (prev is not None and prev.typ == CityItemToken.ItemType.NOUN and (((not prev.doubtful or prev.geo_object_before or MiscLocationHelper.check_geo_object_before(prev.begin_token, False)) or MiscLocationHelper.check_geo_object_before_brief(prev.begin_token, ad)))): 
                            ...
                            if (res1 is not None and ((res1.typ == CityItemToken.ItemType.PROPERNAME or res1.typ == CityItemToken.ItemType.CITY))): 
                                if (res1.value == "ГОРЬКОГО" or res1.value == "ЛЕНИНА"): 
                                    res1.begin_token = t
                                    return res1
            ...
            if (ooo): 
                ...
                while True:
                    ...
                    if (det is not None and ttt.is_value("У", None) and MiscLocationHelper.is_user_param_address(ttt)): 
                        det = (None)
                ...
                if (isinstance(tt, TextToken)): 
                    if (tt0.is_comma and tt0.next0_ is not None): 
                        tt0 = tt0.next0_
                    txt = tt.term
                    if (((txt == "Д" or txt == "С" or txt == "C") or txt == "П" or txt == "Х") or ((((txt == "А" or txt == "У")) and MiscLocationHelper.is_user_param_address(tt)))): 
                        if (tt.chars.is_all_lower or MiscLocationHelper.is_user_param_address(tt) or ((tt.next0_ is not None and tt.next0_.is_char_of(".,")))): 
                            ttt = tt.previous
                            while ttt is not None: 
                                if (StreetItemToken.check_keyword(ttt)): 
                                    return None
                                if (ttt.is_value("ИМЕНИ", None) or ttt.is_value("ИМ", None)): 
                                    return None
                                if (ttt.length_char > 1): 
                                    break
                                ttt = ttt.previous
                            if (NameToken.check_initial(tt) is not None): 
                                return None
                            if (tt.chars.is_all_upper): 
                                tt3 = tt.next0_
                                if (tt3 is not None and tt3.is_char('.')): 
                                    tt3 = tt3.next0_
                                sits = StreetItemToken.try_parse_list(tt3, 3, ad)
                                if (sits is not None and len(sits) == 2 and sits[1].typ == StreetItemType.NOUN): 
                                    return None
                                if (AddressItemToken.try_parse_pure_item(tt.previous, None, None) is not None): 
                                    return None
                            if (txt == "Д"): 
                                hou = AddressItemToken.try_parse_pure_item(tt, None, ad)
                                if ((hou is not None and hou.typ == AddressItemType.HOUSE and not Utils.isNullOrEmpty(hou.value)) and str.isdigit(hou.value[0])): 
                                    return None
                            if (txt == "А" or txt == "С"): 
                                if (tt.is_newline_after and not MiscLocationHelper.is_user_param_address(tt)): 
                                    return None
                                ait = AddressItemToken.try_parse_pure_item(tt.next0_, None, ad)
                                if (ait is not None): 
                                    return None
                                if (StreetItemToken.check_keyword(tt)): 
                                    return None
                            if (txt == "У"): 
                                if (tt.whitespaces_after_count > 2): 
                                    return None
                                next0__ = CityItemToken.try_parse(tt.next0_, None, False, None)
                                if (next0__ is not None and next0__.typ == CityItemToken.ItemType.NOUN): 
                                    return None
                                ait = AddressItemToken.try_parse_pure_item(tt.next0_, None, None)
                                if (ait is not None): 
                                    return None
                            tokn = NameToken.M_ONTO.try_parse(tt, TerminParseAttr.NO)
                            if (tokn is not None): 
                                return CityItemToken._new1370(tt, tokn.end_token, CityItemToken.ItemType.PROPERNAME, tokn.termin.canonic_text)
                            tt1 = tt
                            ...
                            if ((txt == "Д" and (isinstance(tt2, NumberToken)) and not tt2.is_newline_before) and not tt2.previous.is_comma): 
                                ...
                                ok = True
                            elif ((tt2.is_char(')') and t.previous is not None and t.previous.is_char('(')) and MiscLocationHelper.is_user_param_address(t)): 
                                ok = True
                            elif (tt2.is_hiphen and tt2.previous is not None and tt2.previous.is_comma): 
                                ok = True
                                ...
                                if (not ok and MiscLocationHelper.is_user_param_address(tt)): 
                                    ok = True
                                ...
                                if (not ok and tt1.next0_ is not None): 
                                    ...
                                    if (MiscLocationHelper.is_user_param_address(tt)): 
                                        noun = CityItemToken._new1370(tt, tt, CityItemToken.ItemType.NOUN, "СЕЛО")
                                        nam = CityItemToken.__try_parse_int(tt1.next0_, noun, True, ad)
                                        if (nam is not None and nam.typ == CityItemToken.ItemType.PROPERNAME): 
                                            ttt2 = nam.end_token.next0_
                                        if (ttt2 is None or ttt2.is_newline_after or ttt2.is_comma): 
                                            ok = True
                                    if (ttt2 is not None and ttt2.is_comma): 
                                        ttt2 = ttt2.next0_
                                    if (AddressItemToken.check_house_after(ttt2, False, False) or AddressItemToken.check_street_after(ttt2, False)): 
                            ...
                            if (ok): 
                                res = CityItemToken._new1369(tt0, tt1, CityItemToken.ItemType.NOUN)
                                if (tt1.is_comma): 
                                    res.end_token = tt1.previous
                                if (txt == "У"): 
                                    res.value = "УЛУС"
                                else: 
                                    res.value = ("ДЕРЕВНЯ" if txt == "Д" else (("ПОСЕЛОК" if txt == "П" else (("ХУТОР" if txt == "Х" else ("АУЛ" if txt == "А" else ("ГОРОД" if txt == "Г" else "СЕЛО")))))))
                                if (txt == "П"): 
                                    res.alt_value = "ПОСЕЛЕНИЕ"
                                elif (txt == "С" or txt == "C"): 
                                    res.alt_value = "СЕЛЕНИЕ"
                                    if (tt0 == tt1 and not MiscLocationHelper.is_user_param_address(tt0)): 
                    ...
                    if ((txt == "СП" or txt == "РП" or txt == "ГП") or txt == "ДП"): 
                        ...
                        if (tt.next0_ is not None and tt.next0_.chars.is_capital_upper): 
                            return CityItemToken._new1377(tt0, tt, CityItemToken.ItemType.NOUN, True, Condition._new1376(t), ("РАБОЧИЙ ПОСЕЛОК" if txt == "РП" else (("ГОРОДСКОЕ ПОСЕЛЕНИЕ" if txt == "ГП" else (("ДАЧНЫЙ ПОСЕЛОК" if txt == "ДП" else "СЕЛЬСКОЕ ПОСЕЛЕНИЕ"))))))
                    ...
                    if (tt.chars.is_all_upper and tt.length_char > 2 and tt.chars.is_cyrillic_letter): 
                        return CityItemToken._new1370(tt, tt, CityItemToken.ItemType.PROPERNAME, tt.term)
            if ((isinstance(t, NumberToken)) and t.next0_ is not None): 
                ...
                if (net is not None and net.ex_typ == NumberExType.KILOMETER): 
                    return CityItemToken._new1370(t, net.end_token, CityItemToken.ItemType.PROPERNAME, "{0}КМ".format(math.floor(net.real_value)))
            ...
            if ((rt is not None and (isinstance(rt.referent, GeoReferent)) and rt.begin_token == rt.end_token) and rt.referent.is_state): 
                ...
                if (t.previous.morph.number == MorphNumber.SINGULAR and t.morph.case_.is_nominative and not t.morph.case_.is_genitive): 
                    return CityItemToken._new1370(t, t, CityItemToken.ItemType.PROPERNAME, rt.get_source_text().upper())
            return None
        if (res.typ == CityItemToken.ItemType.NOUN): 
            ...
            if (not res.chars.is_all_lower and ((res.value == "ХУТОР" or res.value == "СЛОБОДА"))): 
                res.can_be_name = True
            ...
            if ((res.begin_token.length_char == 1 and res.begin_token.chars.is_all_upper and res.begin_token.next0_ is not None) and res.begin_token.next0_.is_char('.')): 
                ...
                if (ne is not None and ne.typ == CityItemToken.ItemType.CITY and ((not ne.doubtful or MiscLocationHelper.is_user_param_address(ne)))): 
                    pass
                elif (ne is not None and ne.typ == CityItemToken.ItemType.PROPERNAME and AddressItemToken.check_street_after(ne.end_token.next0_, False)): 
                    pass
                elif (ne is not None and ne.typ == CityItemToken.ItemType.NOUN and ne.end_token == res.end_token): 
                    pass
                    ...
                    pass
                elif (res.begin_token.previous is not None and res.begin_token.previous.is_value("В", None)): 
                    pass
                elif ((ne is not None and ne.typ == CityItemToken.ItemType.PROPERNAME and MiscLocationHelper.is_user_param_address(ne)) and ((ne.end_token.is_newline_after or ne.end_token.next0_.is_comma or ne.chars.is_all_upper))): 
                    tt = t.previous
                    while tt is not None: 
                        if (tt.is_newline_after): 
                            break
                        if (TerrItemToken.check_keyword(tt) is not None or TerrItemToken.check_onto_item(tt) is not None): 
                            return res
                        tt = tt.previous
                    return None
                else: 
                    return None
        if (res.typ == CityItemToken.ItemType.PROPERNAME or res.typ == CityItemToken.ItemType.CITY or res.can_be_name): 
            ...
            if (((not t1.is_whitespace_after and t1.next0_ is not None and t1.next0_.is_hiphen) and not t1.next0_.is_whitespace_after and (isinstance(t1.next0_.next0_, NumberToken))) and t1.next0_.next0_.int_value is not None and (t1.next0_.next0_.int_value < 30)): 
                ...
                if (t1.next0_.next0_ is None or t1.next0_.is_newline_after): 
                    ...
                    ok = True
                elif (MiscLocationHelper.check_geo_object_after_brief(t1.next0_, None)): 
                    ok = True
                if (ok): 
                    ...
                    res.typ = CityItemToken.ItemType.PROPERNAME
        if (((res.typ == CityItemToken.ItemType.CITY or res.can_be_name)) and res.begin_token == res.end_token): 
    ...
    def __try_parse(t : 'Token', prev : 'CityItemToken', dont_normalize : bool, ad : 'GeoAnalyzerData') -> 'CityItemToken':
        if (not (isinstance(t, TextToken))): 
            if ((isinstance(t, ReferentToken)) and (isinstance(t.get_referent(), DateReferent))): 
                ...
                if (aii is not None): 
                    if (len(aii) > 1 and aii[0].typ == StreetItemType.NUMBER and aii[1].typ == StreetItemType.STDNAME): 
                        res2 = CityItemToken._new1369(t, aii[1].end_token, CityItemToken.ItemType.PROPERNAME)
                        res2.value = "{0} {1}".format(aii[0].value, aii[1].value)
                        return res2
            if ((((isinstance(t, NumberToken)) and prev is not None and prev.typ == CityItemToken.ItemType.NOUN) and (t.whitespaces_before_count < 3) and (t.whitespaces_after_count < 3)) and (isinstance(t.next0_, TextToken)) and t.next0_.chars.is_capital_upper): 
                ...
                if (cit1 is not None and cit1.typ == CityItemToken.ItemType.PROPERNAME and cit1.value is not None): 
                    ...
                    return cit1
            if ((isinstance(t, NumberToken)) and t.typ != NumberSpellingType.DIGIT and MiscLocationHelper.is_user_param_address(t)): 
                return CityItemToken._new1370(t, t, CityItemToken.ItemType.PROPERNAME, t.value)
            return None
        spec = CityItemToken.__try_parse_spec(t)
        if (spec is not None): 
            return spec
        if (t.is_value("ИМ", None) or t.is_value("ИМЕНИ", None)): 
            nam = NameToken.try_parse(t, GeoTokenType.CITY, 0, False)
            if (nam is not None): 
                res1 = CityItemToken._new1370(t, nam.end_token, CityItemToken.ItemType.PROPERNAME, nam.name)
                if (nam.misc_typ is not None): 
                    res1.misc = nam.misc_typ
                return res1
        li = None
        li0 = None
        ...
        if (li is None): 
            ...
            elif (len(li) == 1 and li[0].begin_token != li[0].end_token and li[0].begin_token.next0_.is_comma): 
                li = (None)
        elif (prev is None): 
            ...
            if (isinstance(t, TextToken)): 
                for i in range(len(li) - 1, -1, -1):
                    if (li[i].item is not None): 
                        if (li[i].begin_token.is_value("ЛЮКСЕМБУРГ", None)): 
                            if (MiscLocationHelper.is_user_param_address(li[i])): 
                                del li[i]
                                continue
                            if (li[i].begin_token.previous is not None and li[i].begin_token.previous.is_value("РОЗА", None)): 
                                del li[i]
                                continue
                        if (li[i].begin_token.is_value("ГРОЗНЫЙ", None)): 
                            if (li[i].begin_token.previous is not None and ((li[i].begin_token.previous.is_value("ИВАН", None) or li[i].begin_token.previous.is_value("ЦАРЬ", None)))): 
                                del li[i]
                                continue
                        if ((li[i].begin_token == li[i].end_token and (isinstance(li[i].begin_token, TextToken)) and li[i].begin_token.term != li[i].item.canonic_text) and MiscLocationHelper.is_user_param_address(li[i])): 
                            if (li[i].begin_token.term.startswith("НН")): 
                                pass
                            else: 
                                del li[i]
                                continue
                        if (((li[i].begin_token == li[i].end_token and not li[i].is_whitespace_after and li[i].end_token.next0_ is not None) and li[i].end_token.next0_.is_hiphen and li[i].end_token.next0_.next0_ is not None) and li[i].end_token.next0_.next0_.is_value("НА", None)): 
                            del li[i]
                            continue
                ...
                for nt in li: 
                    if (nt.item is not None and nt.item.canonic_text == tt.term): 
                        if (MiscLocationHelper.is_user_param_address(nt) or not MiscHelper.is_all_characters_lower(nt.begin_token, nt.end_token, False)): 
                            ci = CityItemToken._new1384(nt.begin_token, nt.end_token, CityItemToken.ItemType.CITY, nt.item, nt.morph)
            ...
            if (li is not None): 
                for nt in li: 
                    if (nt.item is None): 
                        ...
                        ci = CityItemToken._new1386(nt.begin_token, nt.end_token, ty, nt.morph)
                        ...
                        if (ty == CityItemToken.ItemType.MISC and ci.value == "ЖИТЕЛЬ" and t.previous is not None): 
                            ...
                            if (t.previous.morph.class0_.is_pronoun): 
                                return None
                        if (ty == CityItemToken.ItemType.NOUN and t.is_value("СТ", None) and nt.end_token.next0_ is not None): 
                            if (nt.end_token.next0_.is_value("РАЗИН", None)): 
                                return None
                        ...
                        if (nt.begin_token.kit.base_language.is_ru): 
                            if (nt.begin_token.is_value("Г", None)): 
                                if (NameToken.check_initial_and_surname("Г", nt.end_token.next0_)): 
                                    return None
                                if (nt.is_newline_before): 
                                    pass
                                elif (nt.begin_token.previous is not None and nt.begin_token.previous.morph.class0_.is_preposition): 
                                    pass
                                else: 
                                    ok = True
                                    if (not nt.begin_token.chars.is_all_lower and not MiscLocationHelper.is_user_param_address(nt)): 
                                        ok = False
                                        ...
                                        return None
                                    elif (t.previous is not None and StreetItemToken.check_keyword(t.previous)): 
                                        if (AddressItemToken.check_street_after(t.previous, False)): 
                                            return None
                                    if (not ok): 
        ...
        if (t.term == "СПБ" and not t.chars.is_all_lower and CityItemToken.M_ST_PETERBURG is not None): 
            return CityItemToken._new1387(t, t, CityItemToken.ItemType.CITY, CityItemToken.M_ST_PETERBURG, CityItemToken.M_ST_PETERBURG.canonic_text)
        if (t.term == "НЕТ"): 
            return None
        if (t.is_value("МУНИЦИПАЛЬНЫЙ", None)): 
            return None
        if (t.chars.is_all_lower): 
            ...
            if (not MiscLocationHelper.is_user_param_address(t)): 
                return None
            if (StreetItemToken.check_keyword(t) or t.is_value("УЧАСТОК", None) or t.is_value("ДОМ", None)): 
                return None
        ...
        while tt is not None: 
            ...
            if (not tt.next0_.is_hiphen): 
                if (tt.next0_.is_value("ИМ", None) or tt.next0_.is_value("ИМЕНИ", None)): 
                    nam0 = NameToken.try_parse(tt.next0_, GeoTokenType.CITY, 0, False)
                    if (nam0 is not None and nam0.name is not None): 
                        print(" {0}".format(nam0.name), end="", file=name, flush=True)
                        tt = nam0.end_token
                        t1 = tt
                        break
                break
            ...
            if (tt.is_whitespace_after or tt.next0_.is_whitespace_after): 
                ...
                if (ttt is not None and not ttt.is_newline_after): 
                    if (ttt.chars.is_letter): 
                        break
            if (CityItemToken.check_keyword(tt.next0_.next0_) is not None): 
                break
            tt = tt.next0_
            k += 1
            tt = tt.next0_
        if (k > 0): 
            if (k > 2): 
                return None
            reee = CityItemToken._new1388(t, t1, CityItemToken.ItemType.PROPERNAME, Utils.toStringStringIO(name), doubt)
            if (altname is not None): 
        ...
        if (npt is not None): 
            ...
            if (mc.is_proper_surname and not npt.end_token.is_value("ГОРА", None)): 
                npt = (None)
            elif (mc.is_noun): 
                if (CityItemToken.check_keyword(npt.end_token) is not None): 
                    npt = (None)
            elif (not mc.is_undefined): 
                npt = (None)
            elif (npt.end_token.morph.class0_.is_proper_surname): 
                npt = (None)
        ...
        if ((npt is not None and npt.end_token != t and len(npt.adjectives) > 0) and not npt.adjectives[0].end_token.next0_.is_comma): 
            ...
            if (cit is not None and cit.typ == CityItemToken.ItemType.NOUN and ((LanguageHelper.ends_with_ex(cit.value, "ПУНКТ", "ПОСЕЛЕНИЕ", "ПОСЕЛЕННЯ", "ПОСЕЛОК") or t.next0_.is_value("ГОРОДОК", None) or t.next0_.is_value("СЕЛО", None)))): 
                ...
                if (not mc.is_adjective): 
                    ...
                    ok2 = True
                if (ok2): 
                    return CityItemToken._new1389(t, t, CityItemToken.ItemType.CITY, t.get_normal_case_text(None, MorphNumber.UNDEFINED, MorphGender.UNDEFINED, False), npt.morph)
            check_ = True
                ...
                if (npt is not None): 
                    ...
                    if (npt1 is None or len(npt1.adjectives) == 0): 
                        ...
                        if ((si is None or si.typ != StreetItemType.NOUN or si.termin.canonic_text == "МОСТ") or si.termin.canonic_text == "ПАРК" or si.termin.canonic_text == "САД"): 
                            ...
                            return CityItemToken._new1390(t, t1, CityItemToken.ItemType.PROPERNAME, npt.get_normal_case_text(None, MorphNumber.UNDEFINED, MorphGender.UNDEFINED, False), doubt, npt.morph)
        if (t.next0_ is not None and t.next0_.chars.equals(t.chars) and not t.is_newline_after): 
            ...
            if (ok and (((isinstance(t.next0_, TextToken)) or (((isinstance(t.next0_, ReferentToken)) and t.next0_.begin_token == t.next0_.end_token))))): 
                ...
                if ((stat is not None and stat.pair_count >= 2 and stat.pair_count == stat.second_count) and not stat.second_has_other_first): 
                    ...
                    ok1 = True
                elif ((t.next0_.next0_ is not None and t.next0_.next0_.is_comma and t.morph.class0_.is_noun) and ((t.next0_.morph.class0_.is_adjective or t.next0_.morph.class0_.is_noun))): 
                    ok1 = True
                if (not ok1 and t.next0_.chars.value == t.chars.value): 
                    if (t.next0_.morph.case_.is_genitive or (((((LanguageHelper.ends_with(Utils.toStringStringIO(name), "ОВ") or LanguageHelper.ends_with(Utils.toStringStringIO(name), "ВО"))) and (isinstance(t.next0_, TextToken)) and not t.next0_.chars.is_all_lower) and t.next0_.length_char > 1 and not t.next0_.get_morph_class_in_dictionary().is_undefined))): 
                        if (MiscLocationHelper.check_geo_object_after(t.next0_, False, False)): 
                            ok1 = True
                        else: 
                            aid = AddressItemToken.try_parse(t.next0_.next0_, False, None, None)
                            if (aid is not None and not aid.is_doubt): 
                                if (aid.typ == AddressItemType.STREET or aid.typ == AddressItemType.PLOT or aid.typ == AddressItemType.HOUSE): 
                                    ok1 = True
                if (not ok1): 
                    if (AddressItemToken.check_street_after(t.next0_.next0_, False)): 
                        if (not AddressItemToken.check_street_after(t.next0_, False)): 
                            ok1 = True
                if (not ok1 and t.get_morph_class_in_dictionary().is_proper_name and MiscLocationHelper.is_user_param_address(t)): 
                    pp = t.kit.process_referent("PERSON", t, None)
                    if (pp is not None and pp.end_token != t and (isinstance(pp.end_token, TextToken))): 
                        if (TerrItemToken.check_keyword(pp.end_token.next0_) is None): 
                            return CityItemToken._new1391(t, pp.end_token, CityItemToken.ItemType.PROPERNAME, pp.end_token.term, MiscHelper.get_text_value_of_meta_token(pp, GetTextAttr.NO), pp.morph)
                if (ok1): 
                    ...
                    if (tne is not None and tne.typ == CityItemToken.ItemType.NOUN): 
                        ...
                        t1 = t.next0_
                        return CityItemToken._new1392(t, t1, CityItemToken.ItemType.PROPERNAME, Utils.toStringStringIO(name), (None if altname is None else Utils.toStringStringIO(altname)), doubt, t.next0_.morph)
        if (t.length_char < 2): 
            return None
        if (t1 is not None and t1.end_char > t.end_char): 
            t = t1
        else: 
            t1 = t
        ...
        if (((t.next0_ is not None and prev is not None and prev.typ == CityItemToken.ItemType.NOUN) and t.next0_.chars.is_cyrillic_letter and t.next0_.chars.is_all_lower) and t.whitespaces_after_count == 1): 
            ...
            if (tt.next0_ is None or tt.next0_.is_char_of(",;")): 
                ok = True
                next0__ = CityItemToken.try_parse(tt, None, False, None)
                if (next0__ is not None and next0__.typ == CityItemToken.ItemType.NOUN): 
                    ok = False
        ...
        if (StreetItemToken.check_keyword(t)): 
            if (AddressItemToken.check_street_after(t, False)): 
                if (prev is not None and prev.typ == CityItemToken.ItemType.NOUN and t.chars.is_capital_upper): 
                    pass
                else: 
                    return None
        res = CityItemToken._new1392(t, t1, CityItemToken.ItemType.PROPERNAME, Utils.toStringStringIO(name), (None if altname is None else Utils.toStringStringIO(altname)), doubt, t.morph)
        ...
        if ((res.whitespaces_after_count < 2) and (isinstance(res.end_token.next0_, TextToken))): 
            ...
            if (abbr is not None): 
                ...
                res.doubtful = False
                res.misc = abbr.termin.canonic_text
                abbr = CityItemToken.M_SPEC_ABBRS.try_parse(res.end_token.next0_, TerminParseAttr.NO)
                if (abbr is not None): 
                    res.misc2 = abbr.termin.canonic_text
                    res.end_token = abbr.end_token
                ...
                if (abbr is not None and abbr.end_token == res.end_token): 
                    ...
                    if (next0__ is not None and ((next0__.typ == CityItemToken.ItemType.PROPERNAME or next0__.typ == CityItemToken.ItemType.CITY))): 
                        ...
                        res.alt_value = "{0} {1}".format(res.value, next0__.value)
        return res
    ...
    def __try_parse_spec(t : 'Token') -> 'CityItemToken':
        ...
        if (org0_ is not None): 
            return CityItemToken._new1394(t, org0_.end_token, CityItemToken.ItemType.PROPERNAME, org0_)
        tok1 = CityItemToken.M_SPEC_NAMES.try_parse(t, TerminParseAttr.NO)
        if (tok1 is not None): 
            res = CityItemToken._new1370(t, tok1.end_token, CityItemToken.ItemType.PROPERNAME, tok1.termin.canonic_text)
            return res
        tok1 = CityItemToken.M_SPEC_ABBRS.try_parse(t, TerminParseAttr.NO)
        if (tok1 is not None): 
            tt = tok1.end_token.next0_
            tok2 = CityItemToken.M_SPEC_ABBRS.try_parse(tt, TerminParseAttr.NO)
            if (tok2 is not None): 
                tt = tok2.end_token.next0_
            res = None
            if (BracketHelper.can_be_start_of_sequence(tt, True, False)): 
                br = BracketHelper.try_parse(tt, BracketParseAttr.NO, 100)
                if (br is not None): 
                    res = CityItemToken._new1369(t, br.end_token, CityItemToken.ItemType.PROPERNAME)
                    res.value = MiscHelper.get_text_value_of_meta_token(br, GetTextAttr.NO)
            elif (tt is not None): 
                tmp = CityItemToken._new1370(tt.previous, tt.previous, CityItemToken.ItemType.NOUN, "ГОРОД")
                cit = CityItemToken.try_parse(tt, tmp, False, None)
            ...
            if (res is not None): 
                ...
                res.begin_token = t
                if (res.misc is None): 
                    res.misc = tok1.termin.canonic_text
                else: 
                    res.misc2 = tok1.termin.canonic_text
                if (tok2 is not None): 
                    res.misc2 = tok2.termin.canonic_text
                tok2 = CityItemToken.M_SPEC_NAMES.try_parse(res.end_token.next0_, TerminParseAttr.NO)
                if (tok2 is not None): 
                    res.misc2 = tok2.termin.canonic_text
        ...
        while True:
            ...
            if (only_noun): 
                ...
                if (vv is not None and vv.end_token == t): 
                    return CityItemToken._new1370(tt, t, CityItemToken.ItemType.NOUN, vv.termin.canonic_text)
            else: 
    ...
    def __get_normal_geo(t : 'Token') -> str:
        ...
        if (((ch == 'О' or ch == 'В' or ch == 'Ы') or ch == 'И' or ch == 'Х') or ch == 'Ь' or ch == 'Й'): 
            return tt.term
    ...
    def initialize() -> None:
        ...
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1348("ГОРОД-ГЕРОЙ", "ГОРОД")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1400("МІСТО-ГЕРОЙ", MorphLang.UA, "МІСТО")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1348("ГОРОД-КУРОРТ", "ГОРОД")
        t.add_abridge("Г.К.")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1400("МІСТО-КУРОРТ", MorphLang.UA, "МІСТО")
        t.add_abridge("М.К.")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin("СЕЛО")
        ...
        t.add_abridge("П.Г.Т.")
        t.tag = CityItemToken.ItemType.NOUN
        t.add_abridge("ПОС.Г.Т.")
        t.add_variant("ГОРОДСКОЙ ПОСЕЛОК", False)
        t.add_abridge("ГОРОДСКОЙ ПОС.")
        ...
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1403("ГОРОДСКОЕ ПОСЕЛЕНИЕ", "ГП", True)
        t.add_abridge("Г.П.")
        t.tag = CityItemToken.ItemType.NOUN
        t.add_abridge("Г.ПОС.")
        t.add_abridge("ГОР.П.")
        ...
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new138("ПОСЕЛКОВОЕ ПОСЕЛЕНИЕ", "ПОСЕЛОК", CityItemToken.ItemType.NOUN)
        CityItemToken.M_ONTOLOGY.add(t)
        ...
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1348("СТОЛИЦА", "ГОРОД")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1400("СТОЛИЦЯ", MorphLang.UA, "МІСТО")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin("СТАНЦИЯ")
        t.add_abridge("СТАНЦ.")
        ...
        t.add_abridge("НП")
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1348("РАЙОННЫЙ ЦЕНТР", "НАСЕЛЕННЫЙ ПУНКТ")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1400("РАЙОННИЙ ЦЕНТР", MorphLang.UA, "НАСЕЛЕНИЙ ПУНКТ")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1348("ОБЛАСТНОЙ ЦЕНТР", "НАСЕЛЕННЫЙ ПУНКТ")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1400("ОБЛАСНИЙ ЦЕНТР", MorphLang.UA, "НАСЕЛЕНИЙ ПУНКТ")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin("ПОЧИНОК")
        t.tag = CityItemToken.ItemType.NOUN
        ...
        t = Termin("НАСЛЕГ")
        t.tag = CityItemToken.ItemType.NOUN
        t.add_variant("НАЦИОНАЛЬНЫЙ НАСЛЕГ", False)
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin("АРБАН")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        ...
        CityItemToken.M_ONTOLOGY.add(t)
        for s in ["ЖИТЕЛЬ", "МЭР"]: 
            CityItemToken.M_ONTOLOGY.add(Termin._new92(s, CityItemToken.ItemType.MISC))
        for s in ["ЖИТЕЛЬ", "МЕР"]: 
            CityItemToken.M_ONTOLOGY.add(Termin._new483(s, MorphLang.UA, CityItemToken.ItemType.MISC))
        t = Termin._new92("АДМИНИСТРАЦИЯ", CityItemToken.ItemType.MISC)
        t.add_abridge("АДМ.")
        CityItemToken.M_ONTOLOGY.add(t)
        ...
        for s in NameToken._standard_names: 
            ...
            while kk < len(pp): 
                ...
                kk += 1
            CityItemToken.M_SPEC_NAMES.add(t)
    ...
    def __load_big_city(xml0_ : xml.etree.ElementTree.Element) -> None:
        ...
        for x in xml0_: 
            if (Utils.getXmlName(x) == "n"): 
                ...
                if (v == "САНКТ-ПЕТЕРБУРГ"): 
                    ...
                    t.add_abridge("Н-" + vv)
                    t.add_abridge("H-" + vv)
                    t.add_abridge("НИЖ." + vv)
                    t.add_abridge("НИЖН." + vv)
                    t.add_abridge("Н" + vv)
                    t.ignore_terms_order = True
        ...
        if (not Utils.isNullOrEmpty(adj)): 
            ...
            if (spb): 
                city_adj.add(Termin._new483(adj[6:], lang, ci))
    ...
    def check_keyword(t : 'Token') -> 'IntOntologyToken':
        ...
        if (li is not None): 
            for nt in li: 
                if (nt.item is None): 
                    if (nt.termin.canonic_text == "ГОРОДОК" and MiscLocationHelper.is_user_param_address(t)): 
                        return None
                    return nt
        return None
    
    @staticmethod
    def _new1369(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        return res
    
    @staticmethod
    def _new1370(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str) -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        return res
    ...
    @staticmethod
    def _new1377(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : bool, _arg5 : 'Condition', _arg6 : str) -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.doubtful = _arg4
        res._cond = _arg5
    ...
    @staticmethod
    def _new1384(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'IntOntologyItem', _arg5 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.onto_item = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new1386(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.morph = _arg4
        return res
    ...
    @staticmethod
    def _new1387(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'IntOntologyItem', _arg5 : str) -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.onto_item = _arg4
        res.value = _arg5
    ...
    @staticmethod
    def _new1388(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : bool) -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.doubtful = _arg5
    ...
    @staticmethod
    def _new1389(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new1390(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : bool, _arg6 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.doubtful = _arg5
    ...
    @staticmethod
    def _new1391(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : str, _arg6 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.alt_value = _arg5
    ...
    @staticmethod
    def _new1392(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : str, _arg6 : bool, _arg7 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.alt_value = _arg5
    ...
    @staticmethod
    def _new1394(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'ReferentToken') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.org_ref = _arg4
        return res