...
class SourceOfAnalysis:
    ...
    def __init__(self, txt : str) -> None:
        ...
        self.ignored_begin_char = 0
        self.ignored_end_char = 0
    ...
    def __do_cr_lf_correction(self, txt : str) -> str:
        ...
        first_pass4143 = True
        while True:
            if first_pass4143: first_pass4143 = False
            else: i += 1
    ...
    @staticmethod
    def _new91(_arg1 : str, _arg2 : str) -> 'SourceOfAnalysis':
        res = SourceOfAnalysis(_arg1)
        res.user_params = _arg2
        return res
    
    @staticmethod
    def _new624(_arg1 : str, _arg2 : bool) -> 'SourceOfAnalysis':
        res = SourceOfAnalysis(_arg1)
