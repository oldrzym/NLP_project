...
class InstrumentBlockReferent(Referent):
    ...
    def number(self) -> int:
        ...
        if (str0_ is None): 
            return 0
        i = 0
        wrapi2095 = RefOutArgWrapper(0)
        inoutres2096 = Utils.tryParseInt(str0_, wrapi2095)
        i = wrapi2095.value
        if (inoutres2096): 
            return i
        return 0
    ...
    def sub_number(self) -> int:
        ...
        if (str0_ is None): 
            return 0
        i = 0
        wrapi2097 = RefOutArgWrapper(0)
        inoutres2098 = Utils.tryParseInt(str0_, wrapi2097)
        i = wrapi2097.value
        if (inoutres2098): 
            return i
        return 0
    ...
    def sub_number2(self) -> int:
        ...
        if (str0_ is None): 
            return 0
        i = 0
        wrapi2099 = RefOutArgWrapper(0)
        inoutres2100 = Utils.tryParseInt(str0_, wrapi2099)
        i = wrapi2099.value
        if (inoutres2100): 
            return i
        return 0
    ...
    def sub_number3(self) -> int:
        ...
        if (str0_ is None): 
            return 0
        i = 0
        wrapi2101 = RefOutArgWrapper(0)
        inoutres2102 = Utils.tryParseInt(str0_, wrapi2101)
        i = wrapi2101.value
        if (inoutres2102): 
            return i
        return 0
    ...
    def min_number(self) -> int:
        ...
        if (str0_ is None): 
            return 0
        i = 0
        wrapi2103 = RefOutArgWrapper(0)
        inoutres2104 = Utils.tryParseInt(str0_, wrapi2103)
        i = wrapi2103.value
        if (inoutres2104): 
            return i
        return 0
