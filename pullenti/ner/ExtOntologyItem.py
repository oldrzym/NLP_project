...
class ExtOntologyItem:
    ...
    def _serialize(self, stream : Stream) -> None:
        ...
        self.referent.serialize(stream, False)
    ...
    def _deserialize(self, stream : Stream) -> None:
        ...
        if (cou > 0): 
            ...
            while cou > 0: 
                ...
                r.deserialize(stream, self._refs, None, False)
                self._refs.append(r)
                cou -= 1
        self.type_name = SerializerHelper.deserialize_string(stream)
        self.referent = ProcessorService.create_referent(self.type_name)
        self.referent.deserialize(stream, self._refs, None, False)
    
    @staticmethod
    def _new3453(_arg1 : object, _arg2 : 'Referent', _arg3 : str) -> 'ExtOntologyItem':
        res = ExtOntologyItem()
        res.ext_id = _arg1
        res.referent = _arg2
        res.type_name = _arg3
